    ...
    series: [
      {
        ...
        data: [
          { value: 879, name: '本土新增确诊' },
          { value: 1468, name: '本土新增无症状	' },
          { value: 21, name: '新增境外输入' },
          { value: 9396, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 4, addList: [{name: '武汉', num: 4},]},{name: '上海', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '广东', value: 879, addList: [{name: '广州', num: 432},{name: '深圳', num: 81},{name: '江门', num: 62},{name: '潮州', num: 40},{name: '湛江', num: 38},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 528, addList: [{name: '未公布来源', num: 528},]},{name: '四川', value: 96, addList: [{name: '未公布来源', num: 96},]},{name: '海南', value: 207, addList: [{name: '海口', num: 60},{name: '三亚', num: 23},{name: '定安县', num: 20},{name: '澄迈县', num: 15},{name: '万宁', num: 12},]},{name: '河南', value: 80, addList: [{name: '郑州', num: 80},]},{name: '重庆', value: 101, addList: [{name: '未公布来源', num: 101},]},{name: '内蒙古', value: 11, addList: [{name: '呼和浩特', num: 10},{name: '鄂尔多斯', num: 1},]},{name: '福建', value: 41, addList: [{name: '厦门', num: 19},{name: '福州', num: 7},{name: '三明', num: 5},{name: '漳州', num: 2},{name: '南平', num: 2},]},{name: '浙江', value: 106, addList: [{name: '杭州', num: 93},{name: '宁波', num: 7},{name: '衢州', num: 2},{name: '舟山', num: 2},{name: '金华', num: 1},]},{name: '陕西', value: 4, addList: [{name: '渭南', num: 4},]},{name: '黑龙江', value: 13, addList: [{name: '哈尔滨', num: 4},{name: '牡丹江', num: 4},{name: '大兴安岭', num: 3},{name: '佳木斯', num: 1},{name: '鸡西', num: 1},]},{name: '山西', value: 4, addList: [{name: '运城', num: 2},{name: '吕梁', num: 1},{name: '太原', num: 1},]},{name: '云南', value: 19, addList: [{name: '昆明', num: 16},{name: '未公布来源', num: 2},{name: '大理', num: 1},]},{name: '山东', value: 12, addList: [{name: '济南', num: 6},{name: '淄博', num: 3},{name: '青岛', num: 1},{name: '滨州', num: 1},{name: '东营', num: 1},]},{name: '江苏', value: 10, addList: [{name: '南京', num: 7},{name: '苏州', num: 3},]},{name: '辽宁', value: 29, addList: [{name: '沈阳', num: 26},{name: '大连', num: 2},{name: '本溪', num: 1},]},{name: '河北', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '新疆', value: 0, addList: []},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '湖南', value: 7, addList: [{name: '未公布来源', num: 7},]},{name: '广西', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '贵州', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '安徽', value: 1, addList: [{name: '安庆', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
