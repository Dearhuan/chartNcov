    ...
    series: [
      {
        ...
        data: [
          { value: 1868, name: '本土新增确诊' },
          { value: 4785, name: '本土新增无症状	' },
          { value: 14, name: '新增境外输入' },
          { value: 10948, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 15, addList: [{name: '武汉', num: 15},]},{name: '上海', value: 36, addList: [{name: '浦东', num: 5},{name: '松江', num: 4},{name: '闵行', num: 4},{name: '长宁', num: 4},{name: '宝山', num: 4},]},{name: '广东', value: 1868, addList: [{name: '广州', num: 1197},{name: '深圳', num: 119},{name: '中山', num: 97},{name: '佛山', num: 91},{name: '湛江', num: 68},]},{name: '吉林', value: 9, addList: [{name: '松原', num: 5},{name: '长白山管委会', num: 4},]},{name: '北京', value: 708, addList: [{name: '朝阳', num: 149},{name: '昌平', num: 110},{name: '海淀', num: 76},{name: '通州', num: 55},{name: '大兴', num: 43},]},{name: '四川', value: 188, addList: [{name: '成都', num: 149},{name: '外省返川人员', num: 20},{name: '泸州', num: 4},{name: '眉山', num: 3},{name: '凉山', num: 2},]},{name: '海南', value: 55, addList: [{name: '海口', num: 17},{name: '三亚', num: 8},{name: '陵水县', num: 6},{name: '万宁', num: 6},{name: '文昌', num: 5},]},{name: '内蒙古', value: 54, addList: [{name: '呼和浩特', num: 40},{name: '鄂尔多斯', num: 8},{name: '赤峰', num: 6},]},{name: '河南', value: 86, addList: [{name: '郑州', num: 84},{name: '漯河', num: 1},{name: '安阳', num: 1},]},{name: '重庆', value: 260, addList: [{name: '九龙坡区', num: 119},{name: '沙坪坝区', num: 22},{name: '渝北区', num: 17},{name: '江北区', num: 15},{name: '南岸区', num: 9},]},{name: '福建', value: 86, addList: [{name: '漳州', num: 27},{name: '厦门', num: 21},{name: '三明', num: 16},{name: '南平', num: 9},{name: '泉州', num: 6},]},{name: '陕西', value: 31, addList: [{name: '汉中', num: 10},{name: '渭南', num: 7},{name: '西安', num: 4},{name: '榆林', num: 4},{name: '安康', num: 3},]},{name: '山西', value: 149, addList: [{name: '太原', num: 79},{name: '临汾', num: 21},{name: '阳泉', num: 18},{name: '长治', num: 13},{name: '大同', num: 4},]},{name: '黑龙江', value: 92, addList: [{name: '哈尔滨', num: 60},{name: '齐齐哈尔', num: 14},{name: '牡丹江', num: 10},{name: '佳木斯', num: 5},{name: '黑河', num: 1},]},{name: '浙江', value: 150, addList: [{name: '杭州', num: 48},{name: '温州', num: 30},{name: '宁波', num: 23},{name: '湖州', num: 16},{name: '绍兴', num: 11},]},{name: '云南', value: 130, addList: [{name: '昆明', num: 48},{name: '昭通市', num: 35},{name: '迪庆州', num: 14},{name: '红河', num: 5},{name: '曲靖', num: 3},]},{name: '山东', value: 43, addList: [{name: '济南', num: 13},{name: '青岛', num: 8},{name: '威海', num: 6},{name: '临沂', num: 3},{name: '淄博', num: 3},]},{name: '江苏', value: 40, addList: [{name: '南京', num: 11},{name: '宿迁', num: 10},{name: '无锡', num: 6},{name: '苏州', num: 4},{name: '连云港', num: 3},]},{name: '河北', value: 2, addList: [{name: '石家庄', num: 2},]},{name: '辽宁', value: 22, addList: [{name: '盘锦', num: 7},{name: '沈阳', num: 5},{name: '阜新', num: 3},{name: '铁岭', num: 2},{name: '大连', num: 2},]},{name: '天津', value: 0, addList: []},{name: '新疆', value: 11, addList: [{name: '喀什', num: 5},{name: '和田', num: 5},{name: '乌鲁木齐', num: 1},]},{name: '广西', value: 8, addList: [{name: '来宾', num: 6},{name: '桂林', num: 2},]},{name: '湖南', value: 66, addList: [{name: '张家界', num: 16},{name: '株洲', num: 16},{name: '湘潭', num: 10},{name: '益阳', num: 7},{name: '郴州', num: 6},]},{name: '安徽', value: 26, addList: [{name: '宣城', num: 25},{name: '合肥', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '贵州', value: 20, addList: [{name: '未公布来源', num: 20},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 12, addList: [{name: '未公布来源', num: 12},]},{name: '宁夏', value: 1, addList: [{name: '银川', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
