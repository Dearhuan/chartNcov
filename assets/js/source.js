    ...
    series: [
      {
        ...
        data: [
          { value: 727, name: '本土新增确诊' },
          { value: 3541, name: '本土新增无症状	' },
          { value: 15, name: '新增境外输入' },
          { value: 3668, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 1, addList: [{name: '松江', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 727, addList: [{name: '广州', num: 662},{name: '茂名', num: 24},{name: '清远', num: 18},{name: '汕头', num: 9},{name: '深圳', num: 5},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 45, addList: [{name: '成都', num: 22},{name: '外省返川人员', num: 18},{name: '巴中', num: 3},{name: '乐山', num: 1},{name: '眉山', num: 1},]},{name: '内蒙古', value: 114, addList: [{name: '呼和浩特', num: 101},{name: '鄂尔多斯', num: 5},{name: '赤峰', num: 3},{name: '乌兰察布', num: 3},{name: '锡林郭勒', num: 1},]},{name: '福建', value: 6, addList: [{name: '福州', num: 4},{name: '厦门', num: 1},{name: '龙岩', num: 1},]},{name: '北京', value: 161, addList: [{name: '朝阳', num: 86},{name: '海淀', num: 15},{name: '昌平', num: 14},{name: '大兴', num: 8},{name: '顺义', num: 7},]},{name: '陕西', value: 17, addList: [{name: '渭南', num: 6},{name: '安康', num: 5},{name: '西安', num: 3},{name: '汉中', num: 3},]},{name: '浙江', value: 11, addList: [{name: '温州', num: 3},{name: '杭州', num: 2},{name: '宁波', num: 2},{name: '湖州', num: 1},{name: '舟山', num: 1},]},{name: '黑龙江', value: 7, addList: [{name: '哈尔滨', num: 5},{name: '鸡西', num: 2},]},{name: '山东', value: 8, addList: [{name: '菏泽', num: 3},{name: '青岛', num: 2},{name: '泰安', num: 2},{name: '枣庄', num: 1},]},{name: '云南', value: 41, addList: [{name: '红河', num: 18},{name: '昭通市', num: 12},{name: '昆明', num: 5},{name: '玉溪', num: 2},{name: '德宏州', num: 1},]},{name: '江苏', value: 7, addList: [{name: '连云港', num: 5},{name: '盐城', num: 1},{name: '泰州', num: 1},]},{name: '天津', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '重庆', value: 158, addList: [{name: '垫江县', num: 40},{name: '秀山县', num: 31},{name: '沙坪坝区', num: 18},{name: '渝北区', num: 15},{name: '开州区', num: 9},]},{name: '广西', value: 1, addList: [{name: '河池', num: 1},]},{name: '新疆', value: 34, addList: [{name: '乌鲁木齐', num: 27},{name: '伊犁哈萨克自治州', num: 4},{name: '和田', num: 3},]},{name: '辽宁', value: 6, addList: [{name: '沈阳', num: 4},{name: '盘锦', num: 1},{name: '抚顺', num: 1},]},{name: '河北', value: 4, addList: [{name: '石家庄', num: 2},{name: '邯郸', num: 2},]},{name: '山西', value: 40, addList: [{name: '大同', num: 19},{name: '吕梁', num: 9},{name: '忻州', num: 3},{name: '晋城', num: 3},{name: '晋中', num: 2},]},{name: '湖南', value: 7, addList: [{name: '郴州', num: 3},{name: '长沙', num: 2},{name: '株洲', num: 1},{name: '益阳', num: 1},]},{name: '河南', value: 242, addList: [{name: '郑州', num: 241},{name: '许昌', num: 1},]},{name: '安徽', value: 3, addList: [{name: '淮北', num: 2},{name: '合肥', num: 1},]},{name: '江西', value: 1, addList: [{name: '九江', num: 1},]},{name: '西藏', value: 6, addList: [{name: '未公布来源', num: 5},{name: '昌都', num: 1},]},{name: '甘肃', value: 16, addList: [{name: '未公布来源', num: 16},]},{name: '贵州', value: 5, addList: [{name: '贵阳', num: 2},{name: '铜仁', num: 1},{name: '毕节', num: 1},{name: '黔西南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 5, addList: [{name: '西宁', num: 5},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
