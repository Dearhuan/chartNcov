    ...
    series: [
      {
        ...
        data: [
          { value: 1666, name: '本土新增确诊' },
          { value: 5053, name: '本土新增无症状	' },
          { value: 12, name: '新增境外输入' },
          { value: 10466, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 43, addList: [{name: '武汉', num: 43},]},{name: '上海', value: 27, addList: [{name: '徐汇', num: 7},{name: '长宁', num: 5},{name: '浦东', num: 3},{name: '嘉定', num: 3},{name: '虹口', num: 3},]},{name: '吉林', value: 8, addList: []},{name: '广东', value: 1666, addList: [{name: '广州', num: 1201},{name: '深圳', num: 116},{name: '中山', num: 60},{name: '湛江', num: 58},{name: '佛山', num: 53},]},{name: '北京', value: 703, addList: [{name: '朝阳', num: 149},{name: '昌平', num: 110},{name: '海淀', num: 76},{name: '通州', num: 55},{name: '大兴', num: 43},]},{name: '四川', value: 193, addList: [{name: '成都', num: 136},{name: '外省返川人员', num: 30},{name: '泸州', num: 7},{name: '广安', num: 5},{name: '甘孜', num: 4},]},{name: '海南', value: 37, addList: [{name: '海口', num: 12},{name: '三亚', num: 9},{name: '陵水县', num: 3},{name: '五指山市', num: 3},{name: '文昌', num: 2},]},{name: '内蒙古', value: 80, addList: [{name: '呼和浩特', num: 66},{name: '鄂尔多斯', num: 7},{name: '赤峰', num: 6},{name: '锡林郭勒', num: 1},]},{name: '河南', value: 75, addList: [{name: '郑州', num: 75},]},{name: '重庆', value: 205, addList: [{name: '九龙坡区', num: 37},{name: '南岸区', num: 25},{name: '渝北区', num: 19},{name: '沙坪坝区', num: 15},{name: '渝中区', num: 14},]},{name: '福建', value: 78, addList: [{name: '厦门', num: 26},{name: '漳州', num: 16},{name: '三明', num: 10},{name: '南平', num: 8},{name: '泉州', num: 7},]},{name: '陕西', value: 65, addList: [{name: '渭南', num: 27},{name: '汉中', num: 13},{name: '西安', num: 8},{name: '铜川', num: 6},{name: '延安', num: 4},]},{name: '黑龙江', value: 111, addList: [{name: '哈尔滨', num: 87},{name: '齐齐哈尔', num: 15},{name: '佳木斯', num: 3},{name: '双鸭山', num: 3},{name: '绥化', num: 1},]},{name: '山西', value: 187, addList: [{name: '临汾', num: 59},{name: '晋城', num: 58},{name: '阳泉', num: 21},{name: '大同', num: 20},{name: '长治', num: 11},]},{name: '浙江', value: 102, addList: [{name: '杭州', num: 42},{name: '绍兴', num: 18},{name: '宁波', num: 13},{name: '湖州', num: 8},{name: '温州', num: 7},]},{name: '云南', value: 110, addList: [{name: '昆明', num: 46},{name: '昭通市', num: 18},{name: '大理', num: 14},{name: '迪庆州', num: 14},{name: '红河', num: 6},]},{name: '山东', value: 37, addList: [{name: '济南', num: 15},{name: '青岛', num: 8},{name: '临沂', num: 3},{name: '威海', num: 3},{name: '聊城', num: 2},]},{name: '江苏', value: 40, addList: []},{name: '河北', value: 15, addList: [{name: '石家庄', num: 15},]},{name: '辽宁', value: 58, addList: [{name: '沈阳', num: 44},{name: '盘锦', num: 8},{name: '铁岭', num: 2},{name: '大连', num: 2},{name: '阜新', num: 1},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '新疆', value: 130, addList: []},{name: '广西', value: 2, addList: [{name: '来宾', num: 1},{name: '贵港', num: 1},]},{name: '湖南', value: 31, addList: []},{name: '安徽', value: 8, addList: [{name: '宣城', num: 6},{name: '合肥', num: 1},{name: '铜陵', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '贵州', value: 23, addList: [{name: '未公布来源', num: 23},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '宁夏', value: 2, addList: [{name: '银川', num: 2},]},{name: '南海诸岛', value: 0, addList: []}];
