    ...
    series: [
      {
        ...
        data: [
          { value: 860, name: '本土新增确诊' },
          { value: 7951, name: '本土新增无症状	' },
          { value: 23, name: '新增境外输入' },
          { value: 7468, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 9, addList: [{name: '武汉', num: 8},{name: '神农架', num: 1},]},{name: '上海', value: 15, addList: [{name: '嘉定', num: 5},{name: '浦东', num: 2},{name: '松江', num: 2},{name: '闵行', num: 2},{name: '青浦', num: 2},]},{name: '吉林', value: 13, addList: []},{name: '广东', value: 860, addList: [{name: '广州', num: 722},{name: '湛江', num: 46},{name: '肇庆', num: 20},{name: '东莞', num: 16},{name: '深圳', num: 15},]},{name: '海南', value: 10, addList: []},{name: '四川', value: 272, addList: [{name: '成都', num: 176},{name: '外省返川人员', num: 38},{name: '德阳', num: 22},{name: '阿坝', num: 15},{name: '内江', num: 11},]},{name: '北京', value: 388, addList: [{name: '朝阳', num: 117},{name: '通州', num: 96},{name: '海淀', num: 34},{name: '东城', num: 33},{name: '顺义', num: 31},]},{name: '内蒙古', value: 124, addList: []},{name: '福建', value: 15, addList: [{name: '厦门', num: 4},{name: '泉州', num: 3},{name: '福州', num: 3},{name: '龙岩', num: 2},{name: '漳州', num: 2},]},{name: '陕西', value: 37, addList: []},{name: '重庆', value: 215, addList: [{name: '渝北区', num: 50},{name: '垫江县', num: 32},{name: '万州区', num: 25},{name: '南岸区', num: 22},{name: '巴南区', num: 17},]},{name: '浙江', value: 33, addList: [{name: '杭州', num: 17},{name: '宁波', num: 4},{name: '绍兴', num: 4},{name: '衢州', num: 3},{name: '温州', num: 2},]},{name: '黑龙江', value: 63, addList: [{name: '哈尔滨', num: 59},{name: '绥化', num: 2},{name: '鸡西', num: 2},]},{name: '山东', value: 30, addList: [{name: '济南', num: 20},{name: '青岛', num: 3},{name: '泰安', num: 3},{name: '临沂', num: 2},{name: '淄博', num: 1},]},{name: '云南', value: 87, addList: [{name: '昆明', num: 66},{name: '昭通市', num: 9},{name: '丽江市', num: 4},{name: '德宏州', num: 3},{name: '保山市', num: 2},]},{name: '江苏', value: 62, addList: [{name: '南京', num: 40},{name: '连云港', num: 12},{name: '无锡', num: 4},{name: '盐城', num: 3},{name: '镇江', num: 1},]},{name: '河南', value: 115, addList: []},{name: '山西', value: 157, addList: []},{name: '天津', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '新疆', value: 19, addList: [{name: '喀什', num: 7},{name: '乌鲁木齐', num: 6},{name: '和田', num: 6},]},{name: '广西', value: 1, addList: [{name: '桂林', num: 1},]},{name: '辽宁', value: 22, addList: [{name: '沈阳', num: 17},{name: '铁岭', num: 3},{name: '盘锦', num: 1},{name: '阜新', num: 1},]},{name: '河北', value: 45, addList: [{name: '石家庄', num: 45},]},{name: '湖南', value: 12, addList: [{name: '郴州', num: 4},{name: '株洲', num: 2},{name: '长沙', num: 2},{name: '张家界', num: 2},{name: '常德', num: 1},]},{name: '安徽', value: 2, addList: [{name: '合肥', num: 1},{name: '铜陵', num: 1},]},{name: '甘肃', value: 1, addList: [{name: '陇南', num: 1},]},{name: '江西', value: 1, addList: [{name: '九江', num: 1},]},{name: '西藏', value: 0, addList: []},{name: '贵州', value: 20, addList: [{name: '遵义', num: 12},{name: '毕节', num: 5},{name: '贵阳', num: 2},{name: '铜仁', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 7, addList: []},{name: '宁夏', value: 1, addList: [{name: '固原', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
