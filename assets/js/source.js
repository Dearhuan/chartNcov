    ...
    series: [
      {
        ...
        data: [
          { value: 760, name: '本土新增确诊' },
          { value: 2996, name: '本土新增无症状	' },
          { value: 9, name: '新增境外输入' },
          { value: 3193, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 1, addList: [{name: '武汉', num: 1},]},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 760, addList: [{name: '广州', num: 694},{name: '茂名', num: 31},{name: '清远', num: 17},{name: '汕头', num: 10},{name: '深圳', num: 2},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 49, addList: [{name: '外省返川人员', num: 22},{name: '成都', num: 16},{name: '巴中', num: 7},{name: '乐山', num: 1},{name: '内江', num: 1},]},{name: '内蒙古', value: 88, addList: [{name: '呼和浩特', num: 79},{name: '鄂尔多斯', num: 4},{name: '赤峰', num: 2},{name: '通辽', num: 2},{name: '兴安盟', num: 1},]},{name: '福建', value: 4, addList: [{name: '福州', num: 2},{name: '泉州', num: 1},{name: '三明', num: 1},]},{name: '北京', value: 68, addList: [{name: '朝阳', num: 41},{name: '海淀', num: 10},{name: '西城', num: 4},{name: '东城', num: 3},{name: '丰台', num: 3},]},{name: '陕西', value: 14, addList: [{name: '安康', num: 11},{name: '汉中', num: 2},{name: '西安', num: 1},]},{name: '浙江', value: 22, addList: [{name: '宁波', num: 8},{name: '杭州', num: 6},{name: '绍兴', num: 3},{name: '舟山', num: 3},{name: '湖州', num: 1},]},{name: '黑龙江', value: 9, addList: [{name: '哈尔滨', num: 8},{name: '绥化', num: 1},]},{name: '山东', value: 8, addList: [{name: '青岛', num: 4},{name: '济宁', num: 2},{name: '泰安', num: 1},]},{name: '云南', value: 9, addList: [{name: '昭通市', num: 4},{name: '德宏州', num: 3},{name: '昆明', num: 1},{name: '红河', num: 1},]},{name: '江苏', value: 7, addList: [{name: '无锡', num: 2},{name: '淮安', num: 2},{name: '盐城', num: 1},{name: '苏州', num: 1},{name: '泰州', num: 1},]},{name: '天津', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '广西', value: 1, addList: [{name: '北海', num: 1},]},{name: '重庆', value: 160, addList: [{name: '垫江县', num: 33},{name: '沙坪坝区', num: 31},{name: '巴南区', num: 13},{name: '秀山县', num: 13},{name: '南岸区', num: 11},]},{name: '新疆', value: 25, addList: [{name: '乌鲁木齐', num: 25},]},{name: '辽宁', value: 7, addList: [{name: '沈阳', num: 7},]},{name: '河北', value: 0, addList: []},{name: '湖南', value: 5, addList: [{name: '株洲', num: 3},{name: '永州', num: 1},{name: '长沙', num: 1},]},{name: '山西', value: 75, addList: [{name: '大同', num: 50},{name: '吕梁', num: 9},{name: '忻州', num: 8},{name: '太原', num: 4},{name: '晋城', num: 2},]},{name: '安徽', value: 13, addList: [{name: '淮北', num: 13},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '甘肃', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '河南', value: 107, addList: [{name: '郑州', num: 106},{name: '鹤壁', num: 1},]},{name: '贵州', value: 4, addList: [{name: '铜仁', num: 2},{name: '黔东南州', num: 1},{name: '毕节', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 8, addList: [{name: '未公布来源', num: 8},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
