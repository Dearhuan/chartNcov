    ...
    series: [
      {
        ...
        data: [
          { value: 990, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 13, name: '新增境外输入' },
          { value: 6345, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 55, addList: [{name: '未公布来源', num: 55},]},{name: '广东', value: 990, addList: [{name: '广州', num: 451},{name: '汕头', num: 111},{name: '深圳', num: 61},{name: '潮州', num: 52},{name: '茂名', num: 45},]},{name: '吉林', value: 2, addList: [{name: '松原', num: 2},]},{name: '北京', value: 444, addList: [{name: '未公布来源', num: 444},]},{name: '四川', value: 97, addList: [{name: '未公布来源', num: 97},]},{name: '海南', value: 0, addList: []},{name: '重庆', value: 178, addList: [{name: '未公布来源', num: 178},]},{name: '河南', value: 42, addList: [{name: '郑州', num: 42},]},{name: '内蒙古', value: 21, addList: [{name: '未公布来源', num: 21},]},{name: '福建', value: 110, addList: [{name: '福州', num: 38},{name: '漳州', num: 25},{name: '泉州', num: 17},{name: '厦门', num: 13},{name: '莆田', num: 6},]},{name: '浙江', value: 52, addList: [{name: '杭州', num: 43},{name: '宁波', num: 6},{name: '嘉兴', num: 2},{name: '湖州', num: 1},]},{name: '陕西', value: 14, addList: [{name: '未公布来源', num: 14},]},{name: '黑龙江', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '山西', value: 10, addList: [{name: '运城', num: 6},{name: '忻州', num: 3},{name: '临汾', num: 1},]},{name: '山东', value: 54, addList: [{name: '济南', num: 46},{name: '聊城', num: 6},{name: '滨州', num: 2},]},{name: '云南', value: 43, addList: [{name: '未公布来源', num: 43},]},{name: '江苏', value: 7, addList: [{name: '未公布来源', num: 7},]},{name: '辽宁', value: 5, addList: [{name: '沈阳', num: 5},]},{name: '河北', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '天津', value: 29, addList: [{name: '未公布来源', num: 29},]},{name: '新疆', value: 0, addList: []},{name: '湖南', value: 41, addList: [{name: '未公布来源', num: 41},]},{name: '广西', value: 0, addList: []},{name: '贵州', value: 7, addList: [{name: '未公布来源', num: 7},]},{name: '安徽', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
