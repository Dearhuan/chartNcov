    ...
    series: [
      {
        ...
        data: [
          { value: 1246, name: '本土新增确诊' },
          { value: 8576, name: '本土新增无症状	' },
          { value: 10, name: '新增境外输入' },
          { value: 5136, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 4, addList: [{name: '武汉', num: 2},{name: '襄阳', num: 1},{name: '恩施州', num: 1},]},{name: '上海', value: 2, addList: [{name: '松江', num: 2},]},{name: '吉林', value: 1, addList: [{name: '四平', num: 1},]},{name: '广东', value: 1246, addList: [{name: '广州', num: 1189},{name: '东莞', num: 19},{name: '肇庆', num: 15},{name: '深圳', num: 6},{name: '中山', num: 3},]},{name: '海南', value: 5, addList: [{name: '海口', num: 2},{name: '澄迈县', num: 2},{name: '文昌', num: 1},]},{name: '四川', value: 111, addList: [{name: '成都', num: 46},{name: '德阳', num: 32},{name: '外省返川人员', num: 17},{name: '眉山', num: 6},{name: '凉山', num: 4},]},{name: '北京', value: 172, addList: [{name: '朝阳', num: 78},{name: '海淀', num: 32},{name: '顺义', num: 11},{name: '未公布来源', num: 11},{name: '丰台', num: 8},]},{name: '内蒙古', value: 103, addList: [{name: '呼和浩特', num: 77},{name: '鄂尔多斯', num: 20},{name: '兴安盟', num: 3},{name: '赤峰', num: 1},{name: '通辽', num: 1},]},{name: '福建', value: 11, addList: [{name: '厦门', num: 6},{name: '泉州', num: 2},{name: '三明', num: 2},{name: '龙岩', num: 1},]},{name: '陕西', value: 107, addList: [{name: '榆林', num: 94},{name: '安康', num: 6},{name: '西安', num: 2},{name: '渭南', num: 2},{name: '汉中', num: 2},]},{name: '浙江', value: 19, addList: [{name: '杭州', num: 4},{name: '金华', num: 4},{name: '宁波', num: 2},{name: '衢州', num: 2},{name: '湖州', num: 2},]},{name: '黑龙江', value: 10, addList: [{name: '哈尔滨', num: 7},{name: '绥化', num: 3},]},{name: '山东', value: 16, addList: [{name: '青岛', num: 12},{name: '济宁', num: 4},]},{name: '云南', value: 44, addList: [{name: '昆明', num: 34},{name: '曲靖', num: 5},{name: '德宏州', num: 2},{name: '昭通市', num: 1},{name: '红河', num: 1},]},{name: '重庆', value: 172, addList: [{name: '垫江县', num: 22},{name: '巴南区', num: 19},{name: '沙坪坝区', num: 18},{name: '北碚区', num: 17},{name: '梁平区', num: 13},]},{name: '江苏', value: 26, addList: [{name: '连云港', num: 11},{name: '南京', num: 9},{name: '淮安', num: 2},{name: '盐城', num: 1},{name: '无锡', num: 1},]},{name: '天津', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '广西', value: 0, addList: []},{name: '河南', value: 137, addList: [{name: '郑州', num: 136},{name: '许昌', num: 1},]},{name: '新疆', value: 26, addList: [{name: '乌鲁木齐', num: 18},{name: '和田', num: 4},{name: '喀什', num: 3},{name: '克州', num: 1},]},{name: '辽宁', value: 2, addList: [{name: '沈阳', num: 2},]},{name: '山西', value: 71, addList: [{name: '朔州', num: 31},{name: '太原', num: 13},{name: '大同', num: 11},{name: '吕梁', num: 9},{name: '阳泉', num: 4},]},{name: '河北', value: 0, addList: []},{name: '湖南', value: 2, addList: [{name: '岳阳', num: 1},{name: '张家界', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '甘肃', value: 7, addList: [{name: '未公布来源', num: 7},{name: '陇南', num: 5},{name: '兰州', num: 2},]},{name: '贵州', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
