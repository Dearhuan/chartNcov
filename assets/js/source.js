    ...
    series: [
      {
        ...
        data: [
          { value: 1338, name: '本土新增确诊' },
          { value: 9110, name: '本土新增无症状	' },
          { value: 20, name: '新增境外输入' },
          { value: 5928, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 2, addList: [{name: '武汉', num: 2},]},{name: '上海', value: 4, addList: [{name: '松江', num: 2},{name: '浦东', num: 1},{name: '嘉定', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 1338, addList: [{name: '广州', num: 1241},{name: '肇庆', num: 23},{name: '东莞', num: 19},{name: '湛江', num: 19},{name: '深圳', num: 7},]},{name: '海南', value: 2, addList: [{name: '海口', num: 2},]},{name: '四川', value: 109, addList: [{name: '成都', num: 75},{name: '外省返川人员', num: 20},{name: '德阳', num: 8},{name: '凉山', num: 3},{name: '眉山', num: 1},]},{name: '北京', value: 100, addList: [{name: '海淀', num: 39},{name: '朝阳', num: 35},{name: '东城', num: 7},{name: '丰台', num: 3},{name: '门头沟', num: 3},]},{name: '内蒙古', value: 112, addList: [{name: '呼和浩特', num: 81},{name: '鄂尔多斯', num: 30},{name: '呼伦贝尔', num: 1},]},{name: '福建', value: 10, addList: [{name: '厦门', num: 5},{name: '龙岩', num: 3},{name: '泉州', num: 2},]},{name: '陕西', value: 74, addList: [{name: '榆林', num: 66},{name: '西安', num: 3},{name: '安康', num: 2},{name: '渭南', num: 2},{name: '汉中', num: 1},]},{name: '浙江', value: 16, addList: [{name: '舟山', num: 4},{name: '杭州', num: 3},{name: '温州', num: 3},{name: '湖州', num: 2},{name: '宁波', num: 1},]},{name: '黑龙江', value: 10, addList: [{name: '哈尔滨', num: 6},{name: '绥化', num: 4},]},{name: '山东', value: 10, addList: [{name: '青岛', num: 6},{name: '济宁', num: 3},{name: '临沂', num: 1},]},{name: '重庆', value: 193, addList: [{name: '北碚区', num: 37},{name: '南岸区', num: 28},{name: '渝中区', num: 28},{name: '巴南区', num: 17},{name: '渝北区', num: 10},]},{name: '云南', value: 33, addList: [{name: '昆明', num: 41},{name: '昭通市', num: 5},{name: '红河', num: 2},{name: '德宏州', num: 2},{name: '曲靖', num: 1},]},{name: '江苏', value: 21, addList: [{name: '连云港', num: 8},{name: '盐城', num: 8},{name: '南京', num: 4},{name: '泰州', num: 1},]},{name: '天津', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '河南', value: 108, addList: [{name: '郑州', num: 107},{name: '漯河', num: 1},]},{name: '广西', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '新疆', value: 27, addList: [{name: '乌鲁木齐', num: 18},{name: '喀什', num: 4},{name: '克州', num: 1},]},{name: '山西', value: 63, addList: [{name: '大同', num: 19},{name: '太原', num: 19},{name: '朔州', num: 10},{name: '吕梁', num: 6},{name: '忻州', num: 4},]},{name: '辽宁', value: 1, addList: [{name: '沈阳', num: 1},]},{name: '河北', value: 2, addList: [{name: '石家庄', num: 2},]},{name: '湖南', value: 3, addList: [{name: '常德', num: 2},{name: '郴州', num: 1},]},{name: '安徽', value: 1, addList: [{name: '合肥', num: 1},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '甘肃', value: 5, addList: [{name: '兰州', num: 5},]},{name: '贵州', value: 18, addList: [{name: '遵义', num: 10},{name: '毕节', num: 4},{name: '贵阳', num: 2},{name: '黔东南州', num: 1},{name: '黔南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 6, addList: [{name: '西宁', num: 6},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
