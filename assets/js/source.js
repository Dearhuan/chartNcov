    ...
    series: [
      {
        ...
        data: [
          { value: 83, name: '本土新增确诊' },
          { value: 195, name: '本土新增无症状	' },
          { value: 14, name: '新增境外输入' },
          { value: 289, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 83, addList: [{name: '广州', num: 66},{name: '佛山', num: 6},{name: '深圳', num: 6},{name: '江门', num: 3},{name: '阳江', num: 1},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 32, addList: [{name: '绵阳', num: 27},{name: '外省返川人员', num: 3},{name: '成都', num: 1},{name: '德阳', num: 1},]},{name: '福建', value: 41, addList: [{name: '福州', num: 39},{name: '泉州', num: 1},{name: '厦门', num: 1},]},{name: '北京', value: 12, addList: [{name: '朝阳', num: 3},{name: '丰台', num: 2},{name: '平谷区', num: 2},{name: '大兴', num: 2},{name: '未公布来源', num: 1},]},{name: '内蒙古', value: 19, addList: [{name: '呼和浩特', num: 7},{name: '鄂尔多斯', num: 5},{name: '赤峰', num: 3},{name: '包头', num: 3},{name: '通辽', num: 1},]},{name: '陕西', value: 25, addList: [{name: '西安', num: 18},{name: '汉中', num: 4},{name: '渭南', num: 2},{name: '咸阳', num: 1},]},{name: '浙江', value: 0, addList: []},{name: '河南', value: 7, addList: [{name: '郑州', num: 6},{name: '南阳', num: 1},]},{name: '黑龙江', value: 11, addList: [{name: '哈尔滨', num: 5},{name: '绥化', num: 4},{name: '黑河', num: 2},]},{name: '山东', value: 3, addList: [{name: '枣庄', num: 1},{name: '青岛', num: 1},{name: '滨州', num: 1},]},{name: '江苏', value: 25, addList: [{name: '南京', num: 24},{name: '无锡', num: 1},]},{name: '云南', value: 4, addList: [{name: '德宏州', num: 4},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 0, addList: []},{name: '河北', value: 0, addList: []},{name: '辽宁', value: 3, addList: [{name: '锦州', num: 3},]},{name: '新疆', value: 29, addList: [{name: '乌鲁木齐', num: 25},{name: '未公布来源', num: 4},]},{name: '湖南', value: 5, addList: [{name: '邵阳', num: 5},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '甘肃', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '重庆', value: 11, addList: [{name: '永川区', num: 10},{name: '江津区', num: 1},]},{name: '山西', value: 37, addList: [{name: '忻州', num: 17},{name: '大同', num: 8},{name: '朔州', num: 7},{name: '晋中', num: 3},{name: '太原', num: 1},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
