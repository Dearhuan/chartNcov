    ...
    series: [
      {
        ...
        data: [
          { value: 1115, name: '本土新增确诊' },
          { value: 1819, name: '本土新增无症状	' },
          { value: 10, name: '新增境外输入' },
          { value: 11336, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 11, addList: [{name: '武汉', num: 11},]},{name: '上海', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '广东', value: 1115, addList: [{name: '广州', num: 591},{name: '湛江', num: 74},{name: '深圳', num: 62},{name: '云浮', num: 55},{name: '惠州', num: 47},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 924, addList: [{name: '未公布来源', num: 924},]},{name: '四川', value: 100, addList: [{name: '成都', num: 90},{name: '泸州', num: 4},{name: '宜宾', num: 4},{name: '眉山', num: 1},{name: '阿坝', num: 1},]},{name: '海南', value: 122, addList: [{name: '海口', num: 28},{name: '东方', num: 17},{name: '三亚', num: 16},{name: '儋州', num: 9},{name: '澄迈县', num: 7},]},{name: '河南', value: 104, addList: [{name: '郑州', num: 104},]},{name: '内蒙古', value: 35, addList: [{name: '呼和浩特', num: 27},{name: '鄂尔多斯', num: 5},{name: '包头', num: 2},{name: '赤峰', num: 1},]},{name: '重庆', value: 240, addList: [{name: '九龙坡区', num: 131},{name: '南岸区', num: 27},{name: '北碚区', num: 10},{name: '永川区', num: 9},{name: '渝北区', num: 7},]},{name: '福建', value: 80, addList: [{name: '厦门', num: 41},{name: '三明', num: 10},{name: '福州', num: 7},{name: '漳州', num: 5},{name: '泉州', num: 5},]},{name: '陕西', value: 20, addList: [{name: '渭南', num: 15},{name: '安康', num: 3},{name: '西安', num: 1},{name: '咸阳', num: 1},]},{name: '黑龙江', value: 21, addList: [{name: '哈尔滨', num: 12},{name: '齐齐哈尔', num: 4},{name: '鸡西', num: 2},{name: '牡丹江', num: 1},{name: '大兴安岭', num: 1},]},{name: '浙江', value: 71, addList: [{name: '杭州', num: 51},{name: '宁波', num: 5},{name: '温州', num: 4},{name: '金华', num: 3},{name: '绍兴', num: 2},]},{name: '山西', value: 4, addList: [{name: '晋城', num: 2},{name: '朔州', num: 2},]},{name: '云南', value: 39, addList: [{name: '昭通市', num: 13},{name: '昆明', num: 10},{name: '迪庆州', num: 5},{name: '未公布来源', num: 4},{name: '保山市', num: 3},]},{name: '山东', value: 63, addList: [{name: '济南', num: 56},{name: '淄博', num: 4},{name: '威海', num: 1},{name: '聊城', num: 1},{name: '东营', num: 1},]},{name: '江苏', value: 12, addList: [{name: '南京', num: 5},{name: '苏州', num: 4},{name: '宿迁', num: 1},{name: '南通', num: 1},{name: '淮安', num: 1},]},{name: '辽宁', value: 38, addList: [{name: '沈阳', num: 35},{name: '铁岭', num: 3},]},{name: '河北', value: 4, addList: [{name: '石家庄', num: 4},]},{name: '新疆', value: 0, addList: []},{name: '天津', value: 0, addList: []},{name: '广西', value: 1, addList: [{name: '崇左', num: 1},]},{name: '湖南', value: 1, addList: [{name: '郴州', num: 1},]},{name: '贵州', value: 14, addList: [{name: '未公布来源', num: 14},]},{name: '安徽', value: 2, addList: [{name: '安庆', num: 2},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
