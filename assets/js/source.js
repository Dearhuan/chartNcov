    ...
    series: [
      {
        ...
        data: [
          { value: 1157, name: '本土新增确诊' },
          { value: 8381, name: '本土新增无症状	' },
          { value: 21, name: '新增境外输入' },
          { value: 6700, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 8, addList: [{name: '武汉', num: 8},]},{name: '上海', value: 4, addList: [{name: '浦东', num: 2},{name: '松江', num: 2},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 1157, addList: [{name: '广州', num: 1050},{name: '肇庆', num: 44},{name: '东莞', num: 19},{name: '湛江', num: 11},{name: '珠海', num: 7},]},{name: '海南', value: 3, addList: [{name: '三亚', num: 2},{name: '海口', num: 1},]},{name: '四川', value: 156, addList: [{name: '成都', num: 92},{name: '德阳', num: 24},{name: '外省返川人员', num: 14},{name: '内江', num: 9},{name: '宜宾', num: 8},]},{name: '北京', value: 69, addList: [{name: '朝阳', num: 15},{name: '海淀', num: 13},{name: '未公布来源', num: 7},{name: '西城', num: 6},{name: '大兴', num: 6},]},{name: '内蒙古', value: 99, addList: [{name: '呼和浩特', num: 80},{name: '鄂尔多斯', num: 17},{name: '赤峰', num: 2},]},{name: '福建', value: 11, addList: [{name: '厦门', num: 4},{name: '泉州', num: 4},{name: '福州', num: 2},{name: '漳州', num: 1},]},{name: '陕西', value: 33, addList: [{name: '安康', num: 11},{name: '榆林', num: 9},{name: '渭南', num: 6},{name: '西安', num: 4},{name: '汉中', num: 2},]},{name: '浙江', value: 16, addList: [{name: '杭州', num: 5},{name: '湖州', num: 4},{name: '温州', num: 2},{name: '台州', num: 2},{name: '宁波', num: 1},]},{name: '黑龙江', value: 16, addList: [{name: '哈尔滨', num: 12},{name: '绥化', num: 4},]},{name: '重庆', value: 183, addList: [{name: '渝北区', num: 35},{name: '涪陵区', num: 24},{name: '梁平区', num: 18},{name: '巴南区', num: 13},{name: '南岸区', num: 13},]},{name: '山东', value: 20, addList: [{name: '济南', num: 12},{name: '青岛', num: 7},{name: '泰安', num: 1},]},{name: '云南', value: 50, addList: [{name: '昆明', num: 19},{name: '昭通市', num: 16},{name: '玉溪', num: 5},{name: '德宏州', num: 2},{name: '丽江市', num: 2},]},{name: '江苏', value: 38, addList: [{name: '连云港', num: 16},{name: '盐城', num: 14},{name: '南京', num: 3},{name: '镇江', num: 2},{name: '无锡', num: 1},]},{name: '河南', value: 192, addList: [{name: '郑州', num: 189},{name: '济源示范区', num: 2},{name: '许昌', num: 1},]},{name: '天津', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '广西', value: 0, addList: []},{name: '新疆', value: 20, addList: [{name: '乌鲁木齐', num: 8},{name: '喀什', num: 6},{name: '和田', num: 6},]},{name: '山西', value: 81, addList: [{name: '朔州', num: 26},{name: '吕梁', num: 16},{name: '大同', num: 14},{name: '阳泉', num: 9},{name: '太原', num: 8},]},{name: '辽宁', value: 17, addList: [{name: '铁岭', num: 13},{name: '沈阳', num: 3},{name: '抚顺', num: 1},]},{name: '河北', value: 5, addList: [{name: '石家庄', num: 3},{name: '邢台', num: 1},{name: '邯郸', num: 1},]},{name: '湖南', value: 8, addList: [{name: '郴州', num: 2},{name: '常德', num: 2},{name: '衡阳', num: 2},{name: '娄底', num: 1},{name: '长沙', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '甘肃', value: 0, addList: []},{name: '贵州', value: 11, addList: [{name: '遵义', num: 8},{name: '贵阳', num: 2},{name: '黔南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 2, addList: [{name: '西宁', num: 2},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
