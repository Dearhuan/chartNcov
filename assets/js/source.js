    ...
    series: [
      {
        ...
        data: [
          { value: 546, name: '本土新增确诊' },
          { value: 2461, name: '本土新增无症状	' },
          { value: 23, name: '新增境外输入' },
          { value: 2652, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 1, addList: [{name: '武汉', num: 1},]},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 546, addList: [{name: '广州', num: 466},{name: '茂名', num: 26},{name: '汕头', num: 24},{name: '清远', num: 18},{name: '深圳', num: 3},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 41, addList: [{name: '成都', num: 23},{name: '外省返川人员', num: 14},{name: '巴中', num: 3},{name: '乐山', num: 1},]},{name: '内蒙古', value: 98, addList: [{name: '呼和浩特', num: 91},{name: '赤峰', num: 3},{name: '鄂尔多斯', num: 2},{name: '锡林郭勒', num: 1},{name: '通辽', num: 1},]},{name: '福建', value: 0, addList: []},{name: '北京', value: 64, addList: [{name: '朝阳', num: 38},{name: '昌平', num: 7},{name: '东城', num: 5},{name: '未公布来源', num: 4},{name: '通州', num: 4},]},{name: '陕西', value: 5, addList: [{name: '安康', num: 4},{name: '西安', num: 1},]},{name: '浙江', value: 1, addList: [{name: '湖州', num: 1},]},{name: '黑龙江', value: 9, addList: [{name: '哈尔滨', num: 8},{name: '绥化', num: 1},]},{name: '山东', value: 5, addList: [{name: '青岛', num: 3},{name: '枣庄', num: 1},{name: '泰安', num: 1},]},{name: '云南', value: 14, addList: [{name: '昭通市', num: 7},{name: '德宏州', num: 4},{name: '昆明', num: 2},{name: '红河', num: 1},]},{name: '江苏', value: 2, addList: [{name: '南京', num: 1},{name: '镇江', num: 1},]},{name: '天津', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '广西', value: 0, addList: []},{name: '新疆', value: 30, addList: [{name: '乌鲁木齐', num: 29},{name: '伊犁哈萨克自治州', num: 1},]},{name: '辽宁', value: 5, addList: [{name: '沈阳', num: 4},{name: '盘锦', num: 1},]},{name: '河北', value: 1, addList: [{name: '秦皇岛', num: 1},]},{name: '重庆', value: 114, addList: [{name: '沙坪坝区', num: 29},{name: '秀山县', num: 15},{name: '北碚区', num: 12},{name: '巴南区', num: 12},{name: '渝北区', num: 7},]},{name: '湖南', value: 8, addList: [{name: '株洲', num: 3},{name: '邵阳', num: 2},{name: '长沙', num: 1},{name: '岳阳', num: 1},{name: '郴州', num: 1},]},{name: '山西', value: 53, addList: [{name: '大同', num: 46},{name: '忻州', num: 3},{name: '晋中', num: 1},{name: '吕梁', num: 1},{name: '太原', num: 1},]},{name: '安徽', value: 1, addList: [{name: '合肥', num: 1},]},{name: '江西', value: 1, addList: [{name: '萍乡', num: 1},]},{name: '西藏', value: 0, addList: []},{name: '甘肃', value: 15, addList: [{name: '兰州', num: 13},{name: '陇南', num: 2},]},{name: '河南', value: 124, addList: [{name: '郑州', num: 124},]},{name: '贵州', value: 2, addList: [{name: '贵阳', num: 1},{name: '遵义', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 8, addList: [{name: '未公布来源', num: 8},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
