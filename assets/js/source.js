    ...
    series: [
      {
        ...
        data: [
          { value: 1044, name: '本土新增确诊' },
          { value: 1817, name: '本土新增无症状	' },
          { value: 5, name: '新增境外输入' },
          { value: 7376, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 2, addList: [{name: '武汉', num: 2},]},{name: '上海', value: 16, addList: [{name: '未公布来源', num: 16},]},{name: '广东', value: 1044, addList: [{name: '广州', num: 554},{name: '深圳', num: 83},{name: '汕头', num: 69},{name: '江门', num: 54},{name: '云浮', num: 51},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 476, addList: [{name: '未公布来源', num: 476},]},{name: '四川', value: 73, addList: [{name: '未公布来源', num: 73},]},{name: '海南', value: 112, addList: [{name: '海口', num: 59},{name: '三亚', num: 35},{name: '文昌', num: 5},{name: '万宁', num: 4},{name: '澄迈县', num: 3},]},{name: '重庆', value: 179, addList: [{name: '未公布来源', num: 179},]},{name: '河南', value: 66, addList: [{name: '郑州', num: 66},]},{name: '内蒙古', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '福建', value: 70, addList: [{name: '未公布来源', num: 70},]},{name: '浙江', value: 90, addList: [{name: '杭州', num: 71},{name: '宁波', num: 10},{name: '舟山', num: 4},{name: '嘉兴', num: 3},{name: '湖州', num: 2},]},{name: '陕西', value: 19, addList: [{name: '未公布来源', num: 19},]},{name: '黑龙江', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '山西', value: 1, addList: [{name: '临汾', num: 1},]},{name: '山东', value: 20, addList: [{name: '济南', num: 14},{name: '淄博', num: 3},{name: '聊城', num: 1},{name: '东营', num: 1},{name: '潍坊', num: 1},]},{name: '云南', value: 16, addList: [{name: '未公布来源', num: 16},]},{name: '江苏', value: 12, addList: [{name: '南京', num: 9},{name: '苏州', num: 3},]},{name: '辽宁', value: 20, addList: [{name: '沈阳', num: 17},{name: '大连', num: 3},]},{name: '河北', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '新疆', value: 0, addList: []},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '湖南', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '广西', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '贵州', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '安徽', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
