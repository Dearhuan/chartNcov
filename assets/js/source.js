    ...
    series: [
      {
        ...
        data: [
          { value: 291, name: '本土新增确诊' },
          { value: 468, name: '本土新增无症状	' },
          { value: 8, name: '新增境外输入' },
          { value: 557, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 291, addList: [{name: '广州', num: 232},{name: '深圳', num: 21},{name: '佛山', num: 19},{name: '梅州', num: 12},{name: '韶关', num: 3},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 3, addList: [{name: '绵阳', num: 2},{name: '成都', num: 1},]},{name: '福建', value: 12, addList: [{name: '福州', num: 8},{name: '泉州', num: 1},{name: '莆田', num: 1},{name: '厦门', num: 1},{name: '三明', num: 1},]},{name: '北京', value: 16, addList: [{name: '密云', num: 5},{name: '朝阳', num: 3},{name: '未公布来源', num: 3},{name: '平谷区', num: 3},{name: '丰台', num: 1},]},{name: '内蒙古', value: 18, addList: [{name: '呼和浩特', num: 10},{name: '鄂尔多斯', num: 3},{name: '包头', num: 3},{name: '赤峰', num: 1},{name: '通辽', num: 1},]},{name: '陕西', value: 9, addList: [{name: '西安', num: 7},{name: '渭南', num: 1},{name: '榆林', num: 1},]},{name: '浙江', value: 1, addList: [{name: '台州', num: 1},]},{name: '河南', value: 6, addList: [{name: '郑州', num: 5},{name: '南阳', num: 1},]},{name: '黑龙江', value: 3, addList: [{name: '哈尔滨', num: 2},{name: '黑河', num: 1},]},{name: '山东', value: 1, addList: [{name: '枣庄', num: 1},]},{name: '江苏', value: 23, addList: [{name: '南京', num: 21},{name: '无锡', num: 2},]},{name: '云南', value: 3, addList: [{name: '德宏州', num: 3},]},{name: '天津', value: 3, addList: [{name: '津南区', num: 2},{name: '宝坻区', num: 1},]},{name: '广西', value: 0, addList: []},{name: '河北', value: 1, addList: [{name: '石家庄', num: 1},]},{name: '辽宁', value: 1, addList: [{name: '朝阳市', num: 1},]},{name: '新疆', value: 30, addList: [{name: '乌鲁木齐', num: 25},{name: '未公布来源', num: 5},]},{name: '湖南', value: 12, addList: [{name: '邵阳', num: 7},{name: '怀化', num: 5},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '重庆', value: 22, addList: [{name: '永川区', num: 18},{name: '江津区', num: 2},{name: '万州区', num: 1},{name: '合川区', num: 1},]},{name: '甘肃', value: 3, addList: [{name: '兰州', num: 3},]},{name: '山西', value: 16, addList: [{name: '大同', num: 9},{name: '忻州', num: 3},{name: '运城', num: 2},{name: '朔州', num: 2},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
