    ...
    series: [
      {
        ...
        data: [
          { value: 991, name: '本土新增确诊' },
          { value: 7405, name: '本土新增无症状	' },
          { value: 25, name: '新增境外输入' },
          { value: 7456, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 12, addList: [{name: '武汉', num: 12},]},{name: '上海', value: 11, addList: [{name: '松江', num: 3},{name: '浦东', num: 2},{name: '嘉定', num: 1},{name: '闵行', num: 1},{name: '徐汇', num: 1},]},{name: '吉林', value: 11, addList: [{name: '松原', num: 6},{name: '延边', num: 5},]},{name: '广东', value: 991, addList: [{name: '广州', num: 824},{name: '湛江', num: 45},{name: '深圳', num: 24},{name: '佛山', num: 22},{name: '肇庆', num: 13},]},{name: '海南', value: 13, addList: [{name: '乐东', num: 5},{name: '万宁', num: 1},]},{name: '北京', value: 586, addList: [{name: '东城', num: 126},{name: '海淀', num: 103},{name: '朝阳', num: 83},{name: '石景山', num: 45},{name: '通州', num: 43},]},{name: '四川', value: 159, addList: [{name: '成都', num: 101},{name: '外省返川人员', num: 17},{name: '阿坝', num: 9},{name: '广安', num: 5},{name: '泸州', num: 5},]},{name: '内蒙古', value: 116, addList: [{name: '呼和浩特', num: 94},{name: '鄂尔多斯', num: 15},{name: '赤峰', num: 3},{name: '呼伦贝尔', num: 2},{name: '锡林郭勒', num: 1},]},{name: '福建', value: 45, addList: [{name: '厦门', num: 14},{name: '三明', num: 11},{name: '泉州', num: 5},{name: '漳州', num: 5},{name: '福州', num: 4},]},{name: '重庆', value: 199, addList: [{name: '渝北区', num: 23},{name: '万州区', num: 23},{name: '黔江区', num: 19},{name: '城口县', num: 13},{name: '沙坪坝区', num: 9},]},{name: '陕西', value: 39, addList: [{name: '安康', num: 19},{name: '渭南', num: 11},{name: '西安', num: 4},{name: '汉中', num: 2},{name: '榆林', num: 1},]},{name: '黑龙江', value: 134, addList: [{name: '哈尔滨', num: 117},{name: '绥化', num: 5},{name: '佳木斯', num: 5},{name: '黑河', num: 3},{name: '牡丹江', num: 1},]},{name: '浙江', value: 34, addList: [{name: '绍兴', num: 9},{name: '杭州', num: 8},{name: '温州', num: 7},{name: '台州', num: 5},{name: '湖州', num: 3},]},{name: '山东', value: 110, addList: [{name: '济南', num: 50},{name: '聊城', num: 26},{name: '泰安', num: 12},{name: '青岛', num: 11},{name: '临沂', num: 5},]},{name: '河南', value: 186, addList: [{name: '郑州', num: 180},{name: '济源示范区', num: 5},{name: '漯河', num: 1},]},{name: '云南', value: 134, addList: []},{name: '山西', value: 324, addList: [{name: '朔州', num: 105},{name: '太原', num: 96},{name: '吕梁', num: 69},{name: '大同', num: 29},{name: '阳泉', num: 10},]},{name: '江苏', value: 29, addList: [{name: '宿迁', num: 10},{name: '南京', num: 5},{name: '盐城', num: 5},{name: '连云港', num: 2},{name: '无锡', num: 2},]},{name: '河北', value: 101, addList: [{name: '石家庄', num: 93},{name: '廊坊', num: 4},{name: '邯郸', num: 2},{name: '定州', num: 1},{name: '承德', num: 1},]},{name: '天津', value: 6, addList: [{name: '未公布来源', num: 6},]},{name: '新疆', value: 21, addList: []},{name: '广西', value: 13, addList: []},{name: '辽宁', value: 50, addList: [{name: '铁岭', num: 23},{name: '沈阳', num: 17},{name: '抚顺', num: 5},{name: '盘锦', num: 4},]},{name: '湖南', value: 29, addList: [{name: '郴州', num: 9},{name: '张家界', num: 7},{name: '长沙', num: 3},{name: '株洲', num: 3},{name: '娄底', num: 2},]},{name: '安徽', value: 1, addList: [{name: '宣城', num: 1},]},{name: '甘肃', value: 5, addList: [{name: '兰州', num: 5},]},{name: '江西', value: 6, addList: [{name: '景德镇', num: 3},{name: '抚州', num: 2},{name: '九江', num: 1},]},{name: '西藏', value: 2, addList: []},{name: '贵州', value: 31, addList: [{name: '遵义', num: 16},{name: '贵阳', num: 5},{name: '毕节', num: 4},{name: '黔南州', num: 3},{name: '六盘水', num: 2},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 7, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
