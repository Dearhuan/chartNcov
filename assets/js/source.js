    ...
    series: [
      {
        ...
        data: [
          { value: 775, name: '本土新增确诊' },
          { value: 1264, name: '本土新增无症状	' },
          { value: 22, name: '新增境外输入' },
          { value: 8051, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 4, addList: [{name: '武汉', num: 4},]},{name: '上海', value: 14, addList: [{name: '未公布来源', num: 14},]},{name: '广东', value: 775, addList: [{name: '广州', num: 366},{name: '深圳', num: 78},{name: '汕头', num: 60},{name: '惠州', num: 38},{name: '湛江', num: 32},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 559, addList: [{name: '未公布来源', num: 559},]},{name: '四川', value: 71, addList: [{name: '未公布来源', num: 71},]},{name: '海南', value: 186, addList: [{name: '海口', num: 65},{name: '陵水县', num: 35},{name: '三亚', num: 17},{name: '澄迈县', num: 16},{name: '东方', num: 14},]},{name: '河南', value: 74, addList: [{name: '郑州', num: 74},]},{name: '重庆', value: 180, addList: [{name: '未公布来源', num: 180},]},{name: '内蒙古', value: 7, addList: [{name: '未公布来源', num: 7},]},{name: '福建', value: 29, addList: [{name: '南平', num: 10},{name: '厦门', num: 5},{name: '漳州', num: 4},{name: '宁德', num: 4},{name: '泉州', num: 3},]},{name: '浙江', value: 243, addList: [{name: '杭州', num: 232},{name: '宁波', num: 6},{name: '舟山', num: 2},{name: '嘉兴', num: 2},{name: '湖州', num: 1},]},{name: '陕西', value: 8, addList: [{name: '渭南', num: 5},{name: '西安', num: 2},{name: '延安', num: 1},]},{name: '黑龙江', value: 20, addList: [{name: '哈尔滨', num: 10},{name: '牡丹江', num: 5},{name: '大兴安岭', num: 3},{name: '佳木斯', num: 2},]},{name: '山西', value: 12, addList: [{name: '运城', num: 9},{name: '晋城', num: 2},{name: '太原', num: 1},]},{name: '云南', value: 16, addList: [{name: '未公布来源', num: 16},]},{name: '山东', value: 28, addList: [{name: '济南', num: 19},{name: '淄博', num: 4},{name: '青岛', num: 2},{name: '威海', num: 1},{name: '滨州', num: 1},]},{name: '江苏', value: 4, addList: [{name: '南京', num: 2},{name: '苏州', num: 2},]},{name: '辽宁', value: 14, addList: [{name: '沈阳', num: 14},]},{name: '河北', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '新疆', value: 0, addList: []},{name: '天津', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '湖南', value: 9, addList: []},{name: '广西', value: 1, addList: []},{name: '贵州', value: 1, addList: [{name: '铜仁', num: 1},{name: '未公布来源', num: 1},]},{name: '安徽', value: 6, addList: []},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 2, addList: [{name: '南昌', num: 2},]},{name: '西藏', value: 1, addList: [{name: '阿里地区', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 1, addList: [{name: '银川', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
