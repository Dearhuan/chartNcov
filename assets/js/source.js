    ...
    series: [
      {
        ...
        data: [
          { value: 1075, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 36, name: '新增境外输入' },
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 106, addList: [{name: '未公布来源', num: 106},]},{name: '广东', value: 1075, addList: [{name: '广州', num: 537},{name: '深圳', num: 69},{name: '汕头', num: 51},{name: '佛山', num: 51},{name: '茂名', num: 42},]},{name: '吉林', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '北京', value: 456, addList: [{name: '未公布来源', num: 456},]},{name: '四川', value: 93, addList: [{name: '未公布来源', num: 93},]},{name: '海南', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '重庆', value: 189, addList: [{name: '未公布来源', num: 189},]},{name: '河南', value: 45, addList: [{name: '郑州', num: 45},]},{name: '内蒙古', value: 21, addList: [{name: '未公布来源', num: 21},]},{name: '福建', value: 125, addList: [{name: '福州', num: 80},{name: '泉州', num: 19},{name: '厦门', num: 13},{name: '三明', num: 4},{name: '漳州', num: 3},]},{name: '浙江', value: 47, addList: [{name: '杭州', num: 31},{name: '宁波', num: 8},{name: '嘉兴', num: 8},]},{name: '陕西', value: 26, addList: [{name: '未公布来源', num: 26},]},{name: '黑龙江', value: 17, addList: [{name: '未公布来源', num: 17},]},{name: '山西', value: 13, addList: [{name: '运城', num: 7},{name: '临汾', num: 4},{name: '晋城', num: 2},]},{name: '云南', value: 85, addList: [{name: '未公布来源', num: 85},]},{name: '山东', value: 32, addList: [{name: '未公布来源', num: 32},]},{name: '江苏', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '辽宁', value: 0, addList: []},{name: '河北', value: 12, addList: [{name: '未公布来源', num: 12},]},{name: '天津', value: 45, addList: [{name: '未公布来源', num: 45},]},{name: '湖南', value: 115, addList: [{name: '未公布来源', num: 115},]},{name: '新疆', value: 0, addList: []},{name: '广西', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '贵州', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 137, addList: [{name: '未公布来源', num: 137},]},{name: '澳门', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
