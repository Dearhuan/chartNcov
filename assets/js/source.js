    ...
    series: [
      {
        ...
        data: [
          { value: 707, name: '本土新增确诊' },
          { value: 3941, name: '本土新增无症状	' },
          { value: 19, name: '新增境外输入' },
          { value: 4151, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 2, addList: [{name: '武汉', num: 2},]},{name: '上海', value: 2, addList: [{name: '浦东', num: 1},{name: '静安', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 707, addList: [{name: '广州', num: 656},{name: '清远', num: 19},{name: '茂名', num: 17},{name: '韶关', num: 5},{name: '珠海', num: 3},]},{name: '海南', value: 1, addList: [{name: '海口', num: 1},]},{name: '四川', value: 74, addList: [{name: '外省返川人员', num: 30},{name: '成都', num: 30},{name: '德阳', num: 9},{name: '巴中', num: 3},{name: '凉山', num: 2},]},{name: '内蒙古', value: 81, addList: [{name: '呼和浩特', num: 75},{name: '鄂尔多斯', num: 4},{name: '赤峰', num: 2},]},{name: '北京', value: 237, addList: [{name: '朝阳', num: 91},{name: '海淀', num: 28},{name: '通州', num: 24},{name: '昌平', num: 21},{name: '东城', num: 17},]},{name: '福建', value: 17, addList: [{name: '厦门', num: 9},{name: '漳州', num: 5},{name: '福州', num: 3},]},{name: '陕西', value: 17, addList: [{name: '西安', num: 7},{name: '渭南', num: 5},{name: '安康', num: 4},{name: '汉中', num: 1},]},{name: '浙江', value: 34, addList: [{name: '宁波', num: 13},{name: '衢州', num: 6},{name: '金华', num: 4},{name: '湖州', num: 3},{name: '杭州', num: 2},]},{name: '黑龙江', value: 19, addList: [{name: '绥化', num: 10},{name: '哈尔滨', num: 9},]},{name: '山东', value: 4, addList: [{name: '青岛', num: 1},{name: '枣庄', num: 1},{name: '菏泽', num: 1},{name: '济南', num: 1},]},{name: '云南', value: 34, addList: [{name: '昭通市', num: 20},{name: '红河', num: 11},{name: '德宏州', num: 2},{name: '保山市', num: 1},]},{name: '江苏', value: 23, addList: [{name: '连云港', num: 17},{name: '南京', num: 3},{name: '盐城', num: 2},{name: '泰州', num: 1},]},{name: '天津', value: 6, addList: [{name: '宁河区', num: 4},{name: '津南区', num: 2},]},{name: '重庆', value: 150, addList: [{name: '秀山县', num: 29},{name: '沙坪坝区', num: 25},{name: '垫江县', num: 16},{name: '开州区', num: 11},{name: '渝中区', num: 8},]},{name: '广西', value: 0, addList: []},{name: '新疆', value: 29, addList: [{name: '乌鲁木齐', num: 20},{name: '喀什', num: 4},{name: '和田', num: 3},{name: '伊犁哈萨克自治州', num: 2},]},{name: '辽宁', value: 3, addList: [{name: '沈阳', num: 3},]},{name: '河北', value: 5, addList: [{name: '石家庄', num: 3},{name: '沧州', num: 2},]},{name: '山西', value: 34, addList: [{name: '吕梁', num: 11},{name: '大同', num: 8},{name: '忻州', num: 7},{name: '晋城', num: 3},{name: '晋中', num: 2},]},{name: '河南', value: 225, addList: [{name: '郑州', num: 224},{name: '许昌', num: 1},]},{name: '湖南', value: 5, addList: [{name: '郴州', num: 2},{name: '长沙', num: 1},{name: '娄底', num: 1},{name: '张家界', num: 1},]},{name: '安徽', value: 3, addList: [{name: '淮北', num: 3},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '甘肃', value: 7, addList: [{name: '兰州', num: 5},{name: '陇南', num: 2},]},{name: '贵州', value: 15, addList: [{name: '毕节', num: 6},{name: '铜仁', num: 4},{name: '贵阳', num: 3},{name: '六盘水', num: 1},{name: '安顺', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 8, addList: [{name: '西宁', num: 8},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
