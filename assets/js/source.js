    ...
    series: [
      {
        ...
        data: [
          { value: 219, name: '本土新增确诊' },
          { value: 669, name: '本土新增无症状	' },
          { value: 9, name: '新增境外输入' },
          { value: 1258, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 219, addList: [{name: '广州', num: 168},{name: '汕头', num: 26},{name: '茂名', num: 18},{name: '深圳', num: 4},{name: '佛山', num: 1},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 13, addList: [{name: '成都', num: 6},{name: '凉山', num: 2},{name: '巴中', num: 2},{name: '乐山', num: 2},{name: '绵阳', num: 1},]},{name: '福建', value: 44, addList: [{name: '福州', num: 44},]},{name: '内蒙古', value: 75, addList: [{name: '呼和浩特', num: 72},{name: '鄂尔多斯', num: 1},{name: '通辽', num: 1},{name: '乌海', num: 1},]},{name: '北京', value: 37, addList: [{name: '朝阳', num: 16},{name: '昌平', num: 9},{name: '密云', num: 2},{name: '顺义', num: 2},{name: '东城', num: 2},]},{name: '陕西', value: 17, addList: [{name: '西安', num: 13},{name: '延安', num: 3},{name: '安康', num: 1},]},{name: '河南', value: 9, addList: [{name: '郑州', num: 9},]},{name: '浙江', value: 1, addList: [{name: '宁波', num: 1},]},{name: '黑龙江', value: 6, addList: [{name: '绥化', num: 4},{name: '哈尔滨', num: 2},]},{name: '山东', value: 3, addList: [{name: '青岛', num: 2},{name: '枣庄', num: 1},]},{name: '江苏', value: 4, addList: [{name: '盐城', num: 2},{name: '南京', num: 1},{name: '淮安', num: 1},]},{name: '云南', value: 9, addList: [{name: '昆明', num: 5},{name: '德宏州', num: 3},{name: '玉溪', num: 1},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 3, addList: [{name: '丹东', num: 2},{name: '沈阳', num: 1},]},{name: '河北', value: 0, addList: []},{name: '新疆', value: 20, addList: [{name: '乌鲁木齐', num: 17},]},{name: '湖南', value: 34, addList: [{name: '邵阳', num: 31},{name: '怀化', num: 1},{name: '郴州', num: 1},{name: '湘潭', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '山西', value: 61, addList: [{name: '大同', num: 53},{name: '忻州', num: 4},{name: '晋中', num: 2},{name: '吕梁', num: 1},{name: '朔州', num: 1},]},{name: '重庆', value: 39, addList: [{name: '沙坪坝区', num: 13},{name: '大足区', num: 9},{name: '九龙坡区', num: 5},{name: '江北区', num: 5},{name: '万州区', num: 2},]},{name: '西藏', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '贵州', value: 1, addList: [{name: '贵阳', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 1, addList: [{name: '石嘴山', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
