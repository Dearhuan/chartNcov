    ...
    series: [
      {
        ...
        data: [
          { value: 1391, name: '本土新增确诊' },
          { value: 1989, name: '本土新增无症状	' },
          { value: 12, name: '新增境外输入' },
          { value: 11887, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 10, addList: [{name: '武汉', num: 10},]},{name: '上海', value: 28, addList: [{name: '未公布来源', num: 28},]},{name: '广东', value: 1391, addList: [{name: '广州', num: 968},{name: '深圳', num: 67},{name: '阳江', num: 45},{name: '湛江', num: 40},{name: '潮州', num: 37},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 1185, addList: [{name: '朝阳', num: 307},{name: '海淀', num: 123},{name: '通州', num: 122},{name: '昌平', num: 118},{name: '石景山', num: 68},]},{name: '四川', value: 67, addList: [{name: '成都', num: 57},{name: '广元', num: 3},{name: '宜宾', num: 2},{name: '泸州', num: 1},{name: '眉山', num: 1},]},{name: '海南', value: 67, addList: [{name: '陵水县', num: 21},{name: '海口', num: 16},{name: '三亚', num: 6},{name: '东方', num: 4},{name: '文昌', num: 3},]},{name: '河南', value: 198, addList: [{name: '郑州', num: 198},]},{name: '内蒙古', value: 31, addList: [{name: '呼和浩特', num: 26},{name: '鄂尔多斯', num: 2},{name: '赤峰', num: 2},{name: '呼伦贝尔', num: 1},]},{name: '重庆', value: 111, addList: [{name: '九龙坡区', num: 19},{name: '巴南区', num: 12},{name: '武隆区', num: 12},{name: '荣昌区', num: 11},{name: '南岸区', num: 10},]},{name: '福建', value: 96, addList: [{name: '厦门', num: 67},{name: '福州', num: 8},{name: '三明', num: 7},{name: '漳州', num: 5},{name: '泉州', num: 4},]},{name: '陕西', value: 19, addList: [{name: '安康', num: 7},{name: '渭南', num: 5},{name: '铜川', num: 4},{name: '榆林', num: 3},]},{name: '黑龙江', value: 48, addList: [{name: '齐齐哈尔', num: 18},{name: '哈尔滨', num: 16},{name: '大兴安岭', num: 7},{name: '牡丹江', num: 3},{name: '佳木斯', num: 3},]},{name: '浙江', value: 73, addList: [{name: '杭州', num: 30},{name: '温州', num: 17},{name: '绍兴', num: 12},{name: '舟山', num: 10},{name: '宁波', num: 2},]},{name: '山西', value: 13, addList: [{name: '晋城', num: 5},{name: '太原', num: 2},{name: '长治', num: 2},{name: '忻州', num: 2},{name: '临汾', num: 1},]},{name: '云南', value: 45, addList: [{name: '昆明', num: 10},{name: '昭通市', num: 4},{name: '未公布来源', num: 4},{name: '大理', num: 4},{name: '普洱', num: 4},]},{name: '山东', value: 64, addList: [{name: '济南', num: 56},{name: '威海', num: 2},{name: '淄博', num: 2},{name: '聊城', num: 2},{name: '滨州', num: 1},]},{name: '江苏', value: 25, addList: [{name: '南京', num: 11},{name: '苏州', num: 5},{name: '宿迁', num: 2},{name: '连云港', num: 2},{name: '盐城', num: 2},]},{name: '辽宁', value: 52, addList: [{name: '沈阳', num: 47},{name: '铁岭', num: 2},{name: '大连', num: 2},{name: '鞍山', num: 1},]},{name: '河北', value: 2, addList: [{name: '石家庄', num: 2},]},{name: '新疆', value: 2, addList: [{name: '喀什', num: 2},]},{name: '天津', value: 2, addList: [{name: '北辰区', num: 1},{name: '红桥区', num: 1},]},{name: '广西', value: 2, addList: [{name: '崇左', num: 2},]},{name: '湖南', value: 14, addList: [{name: '长沙', num: 10},{name: '益阳', num: 1},{name: '岳阳', num: 1},{name: '常德', num: 1},{name: '邵阳', num: 1},]},{name: '贵州', value: 30, addList: []},{name: '安徽', value: 1, addList: [{name: '合肥', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
