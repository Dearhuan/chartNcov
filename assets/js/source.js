    ...
    series: [
      {
        ...
        data: [
          { value: 1719, name: '本土新增确诊' },
          { value: 3200, name: '本土新增无症状	' },
          { value: 15, name: '新增境外输入' },
          { value: 12440, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 18, addList: [{name: '武汉', num: 18},]},{name: '上海', value: 24, addList: [{name: '浦东', num: 9},{name: '松江', num: 3},{name: '闵行', num: 3},{name: '静安', num: 2},{name: '嘉定', num: 1},]},{name: '广东', value: 1719, addList: [{name: '广州', num: 1233},{name: '深圳', num: 116},{name: '中山', num: 67},{name: '湛江', num: 47},{name: '潮州', num: 39},]},{name: '吉林', value: 1, addList: []},{name: '北京', value: 1170, addList: [{name: '朝阳', num: 333},{name: '石景山', num: 128},{name: '海淀', num: 113},{name: '昌平', num: 95},{name: '西城', num: 69},]},{name: '四川', value: 214, addList: [{name: '成都', num: 179},{name: '外省返川人员', num: 10},{name: '内江', num: 5},{name: '泸州', num: 4},{name: '眉山', num: 4},]},{name: '海南', value: 85, addList: []},{name: '内蒙古', value: 77, addList: []},{name: '河南', value: 154, addList: [{name: '郑州', num: 149},{name: '漯河', num: 4},{name: '鹤壁', num: 1},]},{name: '重庆', value: 184, addList: [{name: '渝北区', num: 41},{name: '江北区', num: 18},{name: '北碚区', num: 18},{name: '九龙坡区', num: 16},{name: '巴南区', num: 11},]},{name: '福建', value: 154, addList: [{name: '泉州', num: 39},{name: '厦门', num: 38},{name: '漳州', num: 31},{name: '三明', num: 25},{name: '福州', num: 6},]},{name: '陕西', value: 42, addList: [{name: '渭南', num: 12},{name: '汉中', num: 10},{name: '铜川', num: 7},]},{name: '黑龙江', value: 118, addList: []},{name: '浙江', value: 94, addList: [{name: '杭州', num: 31},{name: '宁波', num: 29},{name: '绍兴', num: 14},{name: '衢州', num: 14},{name: '舟山', num: 5},]},{name: '山西', value: 17, addList: [{name: '大同', num: 5},{name: '阳泉', num: 3},{name: '晋城', num: 3},{name: '临汾', num: 2},{name: '晋中', num: 2},]},{name: '云南', value: 411, addList: []},{name: '山东', value: 31, addList: [{name: '济南', num: 21},{name: '威海', num: 5},{name: '淄博', num: 3},{name: '聊城', num: 1},{name: '滨州', num: 1},]},{name: '江苏', value: 40, addList: [{name: '南京', num: 14},{name: '南通', num: 8},{name: '苏州', num: 6},{name: '连云港', num: 5},{name: '无锡', num: 3},]},{name: '河北', value: 2, addList: [{name: '定州', num: 2},]},{name: '辽宁', value: 51, addList: [{name: '沈阳', num: 41},{name: '铁岭', num: 6},{name: '本溪', num: 2},{name: '朝阳市', num: 2},]},{name: '新疆', value: 6, addList: [{name: '和田', num: 3},{name: '喀什', num: 2},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 1, addList: [{name: '来宾', num: 1},]},{name: '湖南', value: 14, addList: []},{name: '安徽', value: 5, addList: [{name: '宣城', num: 2},{name: '铜陵', num: 2},{name: '合肥', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 2, addList: []},{name: '贵州', value: 80, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 5, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
