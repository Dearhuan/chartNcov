    ...
    series: [
      {
        ...
        data: [
          { value: 242, name: '本土新增确诊' },
          { value: 458, name: '本土新增无症状	' },
          { value: 7, name: '新增境外输入' },
          { value: 766, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 2, addList: [{name: '浦东', num: 2},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 242, addList: [{name: '广州', num: 190},{name: '深圳', num: 23},{name: '梅州', num: 16},{name: '汕头', num: 8},{name: '江门', num: 3},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 9, addList: [{name: '外省返川人员', num: 5},{name: '广元', num: 3},{name: '成都', num: 2},{name: '德阳', num: 1},{name: '凉山', num: 1},]},{name: '福建', value: 82, addList: [{name: '福州', num: 82},]},{name: '北京', value: 21, addList: [{name: '密云', num: 10},{name: '通州', num: 3},{name: '朝阳', num: 2},{name: '未公布来源', num: 2},{name: '平谷区', num: 2},]},{name: '内蒙古', value: 13, addList: [{name: '呼和浩特', num: 7},{name: '鄂尔多斯', num: 5},{name: '赤峰', num: 1},]},{name: '陕西', value: 11, addList: [{name: '西安', num: 6},{name: '汉中', num: 1},{name: '渭南', num: 1},{name: '咸阳', num: 1},{name: '榆林', num: 1},]},{name: '浙江', value: 0, addList: []},{name: '河南', value: 13, addList: [{name: '郑州', num: 13},]},{name: '黑龙江', value: 5, addList: [{name: '绥化', num: 3},{name: '哈尔滨', num: 1},{name: '牡丹江', num: 1},]},{name: '山东', value: 7, addList: [{name: '青岛', num: 4},{name: '枣庄', num: 3},]},{name: '江苏', value: 16, addList: [{name: '南京', num: 16},]},{name: '云南', value: 3, addList: [{name: '德宏州', num: 2},{name: '临沧', num: 1},]},{name: '天津', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '广西', value: 0, addList: []},{name: '河北', value: 0, addList: []},{name: '辽宁', value: 0, addList: []},{name: '新疆', value: 23, addList: [{name: '乌鲁木齐', num: 19},]},{name: '湖南', value: 15, addList: [{name: '邵阳', num: 10},{name: '怀化', num: 5},]},{name: '安徽', value: 1, addList: [{name: '合肥', num: 1},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '重庆', value: 7, addList: [{name: '永川区', num: 7},]},{name: '甘肃', value: 3, addList: [{name: '兰州', num: 3},{name: '未公布来源', num: 3},]},{name: '山西', value: 17, addList: [{name: '大同', num: 7},{name: '忻州', num: 4},{name: '朔州', num: 2},{name: '吕梁', num: 2},{name: '阳泉', num: 1},]},{name: '贵州', value: 2, addList: [{name: '贵阳', num: 1},{name: '黔南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 2, addList: [{name: '西宁', num: 2},]},{name: '宁夏', value: 2, addList: [{name: '吴忠', num: 2},]},{name: '南海诸岛', value: 0, addList: []}];
