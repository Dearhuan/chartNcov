    ...
    series: [
      {
        ...
        data: [
          { value: 984, name: '本土新增确诊' },
          { value: 8101, name: '本土新增无症状	' },
          { value: 38, name: '新增境外输入' },
          { value: 6977, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 6, addList: [{name: '武汉', num: 6},]},{name: '上海', value: 6, addList: [{name: '浦东', num: 4},{name: '徐汇', num: 1},{name: '杨浦', num: 1},]},{name: '吉林', value: 6, addList: [{name: '松原', num: 5},{name: '长春', num: 1},]},{name: '广东', value: 984, addList: [{name: '广州', num: 882},{name: '湛江', num: 36},{name: '肇庆', num: 31},{name: '佛山', num: 8},{name: '深圳', num: 6},]},{name: '海南', value: 4, addList: [{name: '海口', num: 3},{name: '三亚', num: 1},]},{name: '四川', value: 217, addList: [{name: '成都', num: 136},{name: '德阳', num: 31},{name: '外省返川人员', num: 29},{name: '内江', num: 10},{name: '眉山', num: 2},]},{name: '北京', value: 154, addList: [{name: '朝阳', num: 54},{name: '通州', num: 50},{name: '海淀', num: 9},{name: '东城', num: 7},{name: '丰台', num: 6},]},{name: '内蒙古', value: 92, addList: [{name: '呼和浩特', num: 71},{name: '鄂尔多斯', num: 19},{name: '赤峰', num: 1},{name: '呼伦贝尔', num: 1},]},{name: '福建', value: 20, addList: [{name: '泉州', num: 6},{name: '三明', num: 6},{name: '福州', num: 4},{name: '厦门', num: 2},{name: '龙岩', num: 2},]},{name: '陕西', value: 29, addList: [{name: '榆林', num: 6},{name: '安康', num: 6},{name: '西安', num: 5},{name: '渭南', num: 4},{name: '汉中', num: 3},]},{name: '浙江', value: 23, addList: [{name: '杭州', num: 9},{name: '衢州', num: 5},{name: '温州', num: 4},{name: '宁波', num: 2},{name: '湖州', num: 2},]},{name: '重庆', value: 231, addList: [{name: '渝北区', num: 43},{name: '南岸区', num: 27},{name: '大渡口区', num: 20},{name: '涪陵区', num: 20},{name: '巴南区', num: 13},]},{name: '黑龙江', value: 17, addList: [{name: '哈尔滨', num: 12},{name: '绥化', num: 4},{name: '黑河', num: 1},]},{name: '山东', value: 26, addList: [{name: '济南', num: 22},{name: '青岛', num: 3},{name: '泰安', num: 1},]},{name: '云南', value: 37, addList: [{name: '昆明', num: 22},{name: '昭通市', num: 8},{name: '德宏州', num: 3},{name: '曲靖', num: 1},{name: '玉溪', num: 1},]},{name: '江苏', value: 56, addList: [{name: '盐城', num: 19},{name: '连云港', num: 17},{name: '南京', num: 12},{name: '镇江', num: 6},{name: '苏州', num: 1},]},{name: '河南', value: 161, addList: [{name: '郑州', num: 161},]},{name: '天津', value: 6, addList: [{name: '未公布来源', num: 6},]},{name: '山西', value: 120, addList: [{name: '朔州', num: 47},{name: '阳泉', num: 20},{name: '大同', num: 17},{name: '吕梁', num: 12},{name: '太原', num: 11},]},{name: '新疆', value: 18, addList: [{name: '乌鲁木齐', num: 6},{name: '喀什', num: 6},{name: '和田', num: 6},]},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 15, addList: [{name: '沈阳', num: 8},{name: '铁岭', num: 6},{name: '抚顺', num: 1},]},{name: '河北', value: 2, addList: [{name: '石家庄', num: 2},]},{name: '湖南', value: 3, addList: [{name: '常德', num: 2},{name: '郴州', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 5, addList: [{name: '九江', num: 5},]},{name: '甘肃', value: 18, addList: [{name: '兰州', num: 18},]},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '贵州', value: 10, addList: [{name: '毕节', num: 7},{name: '遵义', num: 2},{name: '铜仁', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 9, addList: [{name: '西宁', num: 9},]},{name: '宁夏', value: 1, addList: [{name: '中卫', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
