    ...
    series: [
      {
        ...
        data: [
          { value: 252, name: '本土新增确诊' },
          { value: 1330, name: '本土新增无症状	' },
          { value: 21, name: '新增境外输入' },
          { value: 1427, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 252, addList: [{name: '广州', num: 183},{name: '汕头', num: 33},{name: '茂名', num: 31},{name: '深圳', num: 1},{name: '佛山', num: 1},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 6, addList: [{name: '外省返川人员', num: 2},{name: '乐山', num: 2},{name: '绵阳', num: 1},{name: '巴中', num: 1},]},{name: '福建', value: 4, addList: [{name: '南平', num: 2},{name: '福州', num: 1},{name: '漳州', num: 1},]},{name: '内蒙古', value: 43, addList: [{name: '呼和浩特', num: 39},{name: '鄂尔多斯', num: 2},{name: '乌海', num: 1},{name: '锡林郭勒', num: 1},]},{name: '北京', value: 43, addList: [{name: '朝阳', num: 18},{name: '昌平', num: 12},{name: '海淀', num: 3},{name: '丰台', num: 3},{name: '未公布来源', num: 2},]},{name: '陕西', value: 9, addList: [{name: '西安', num: 6},{name: '安康', num: 2},{name: '咸阳', num: 1},]},{name: '河南', value: 16, addList: [{name: '郑州', num: 15},{name: '信阳', num: 1},]},{name: '浙江', value: 1, addList: [{name: '杭州', num: 1},]},{name: '黑龙江', value: 7, addList: [{name: '哈尔滨', num: 5},{name: '绥化', num: 2},]},{name: '山东', value: 7, addList: [{name: '青岛', num: 5},{name: '枣庄', num: 2},]},{name: '江苏', value: 2, addList: [{name: '南京', num: 2},]},{name: '云南', value: 11, addList: [{name: '昆明', num: 7},{name: '德宏州', num: 3},{name: '昭通市', num: 1},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 1, addList: [{name: '丹东', num: 1},]},{name: '河北', value: 1, addList: [{name: '定州', num: 1},]},{name: '新疆', value: 23, addList: [{name: '乌鲁木齐', num: 20},{name: '伊犁哈萨克自治州', num: 3},]},{name: '湖南', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '安徽', value: 0, addList: []},{name: '重庆', value: 40, addList: [{name: '沙坪坝区', num: 14},{name: '大足区', num: 13},{name: '江津区', num: 3},{name: '万州区', num: 2},{name: '铜梁区', num: 2},]},{name: '山西', value: 35, addList: [{name: '大同', num: 31},{name: '吕梁', num: 2},{name: '忻州', num: 1},{name: '晋中', num: 1},]},{name: '江西', value: 1, addList: [{name: '萍乡', num: 1},]},{name: '西藏', value: 0, addList: []},{name: '甘肃', value: 6, addList: [{name: '兰州', num: 6},]},{name: '贵州', value: 2, addList: [{name: '贵阳', num: 1},{name: '黔东南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
