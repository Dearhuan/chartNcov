    ...
    series: [
      {
        ...
        data: [
          { value: 195, name: '本土新增确诊' },
          { value: 470, name: '本土新增无症状	' },
          { value: 13, name: '新增境外输入' },
          { value: 1102, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 1, addList: [{name: '普陀', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 195, addList: [{name: '广州', num: 149},{name: '汕头', num: 19},{name: '深圳', num: 9},{name: '茂名', num: 8},{name: '梅州', num: 6},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 15, addList: [{name: '阿坝', num: 5},{name: '成都', num: 4},{name: '外省返川人员', num: 2},{name: '绵阳', num: 1},{name: '德阳', num: 1},]},{name: '福建', value: 39, addList: [{name: '福州', num: 37},{name: '南平', num: 2},]},{name: '内蒙古', value: 239, addList: [{name: '呼和浩特', num: 238},{name: '鄂尔多斯', num: 1},]},{name: '北京', value: 32, addList: [{name: '昌平', num: 9},{name: '密云', num: 7},{name: '朝阳', num: 6},{name: '海淀', num: 4},{name: '未公布来源', num: 2},]},{name: '陕西', value: 11, addList: [{name: '西安', num: 8},{name: '安康', num: 3},]},{name: '河南', value: 22, addList: [{name: '郑州', num: 21},{name: '许昌', num: 1},]},{name: '浙江', value: 1, addList: [{name: '宁波', num: 1},]},{name: '黑龙江', value: 11, addList: [{name: '哈尔滨', num: 10},{name: '绥化', num: 1},]},{name: '山东', value: 10, addList: [{name: '青岛', num: 8},{name: '枣庄', num: 1},{name: '威海', num: 1},]},{name: '江苏', value: 3, addList: [{name: '无锡', num: 1},{name: '盐城', num: 1},{name: '宿迁', num: 1},]},{name: '云南', value: 5, addList: [{name: '德宏州', num: 3},{name: '临沧', num: 1},{name: '昆明', num: 1},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 2, addList: [{name: '沈阳', num: 2},]},{name: '河北', value: 0, addList: []},{name: '新疆', value: 22, addList: [{name: '乌鲁木齐', num: 20},{name: '未公布来源', num: 2},]},{name: '湖南', value: 10, addList: [{name: '邵阳', num: 6},{name: '怀化', num: 2},{name: '株洲', num: 1},{name: '益阳', num: 1},]},{name: '安徽', value: 1, addList: [{name: '合肥', num: 1},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '重庆', value: 41, addList: [{name: '沙坪坝区', num: 17},{name: '九龙坡区', num: 5},{name: '铜梁区', num: 4},{name: '永川区', num: 3},{name: '大足区', num: 3},]},{name: '山西', value: 30, addList: [{name: '大同', num: 22},{name: '吕梁', num: 4},{name: '阳泉', num: 2},{name: '晋中', num: 2},]},{name: '甘肃', value: 8, addList: [{name: '兰州', num: 8},]},{name: '贵州', value: 2, addList: [{name: '贵阳', num: 1},{name: '铜仁', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '宁夏', value: 2, addList: [{name: '中卫', num: 1},{name: '吴忠', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
