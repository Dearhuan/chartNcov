    ...
    series: [
      {
        ...
        data: [
          { value: 564, name: '本土新增确诊' },
          { value: 6215, name: '本土新增无症状	' },
          { value: 24, name: '新增境外输入' },
          { value: 4390, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 4, addList: [{name: '武汉', num: 4},]},{name: '上海', value: 2, addList: [{name: '松江', num: 1},{name: '奉贤', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 564, addList: [{name: '广州', num: 509},{name: '肇庆', num: 12},{name: '深圳', num: 9},{name: '东莞', num: 9},{name: '茂名', num: 8},]},{name: '海南', value: 6, addList: [{name: '海口', num: 3},{name: '三亚', num: 1},{name: '澄迈县', num: 1},{name: '琼海', num: 1},]},{name: '四川', value: 61, addList: [{name: '成都', num: 40},{name: '外省返川人员', num: 11},{name: '德阳', num: 8},{name: '巴中', num: 1},{name: '眉山', num: 1},]},{name: '北京', value: 197, addList: [{name: '朝阳', num: 102},{name: '昌平', num: 16},{name: '顺义', num: 14},{name: '海淀', num: 12},{name: '大兴', num: 12},]},{name: '内蒙古', value: 82, addList: [{name: '呼和浩特', num: 73},{name: '赤峰', num: 5},{name: '鄂尔多斯', num: 3},{name: '乌兰察布', num: 1},]},{name: '福建', value: 19, addList: [{name: '厦门', num: 6},{name: '泉州', num: 6},{name: '福州', num: 3},{name: '漳州', num: 3},{name: '龙岩', num: 1},]},{name: '陕西', value: 62, addList: [{name: '榆林', num: 34},{name: '西安', num: 23},{name: '安康', num: 3},{name: '渭南', num: 1},{name: '汉中', num: 1},]},{name: '浙江', value: 12, addList: [{name: '宁波', num: 5},{name: '杭州', num: 3},{name: '温州', num: 2},{name: '衢州', num: 1},{name: '台州', num: 1},]},{name: '黑龙江', value: 35, addList: [{name: '绥化', num: 26},{name: '哈尔滨', num: 7},{name: '黑河', num: 2},]},{name: '山东', value: 13, addList: [{name: '青岛', num: 8},{name: '济宁', num: 3},{name: '济南', num: 2},]},{name: '云南', value: 22, addList: [{name: '昆明', num: 7},{name: '昭通市', num: 6},{name: '红河', num: 3},{name: '德宏州', num: 3},{name: '曲靖', num: 2},]},{name: '江苏', value: 25, addList: [{name: '连云港', num: 13},{name: '南京', num: 4},{name: '盐城', num: 4},{name: '无锡', num: 4},]},{name: '重庆', value: 126, addList: [{name: '沙坪坝区', num: 23},{name: '北碚区', num: 18},{name: '巴南区', num: 10},{name: '大渡口区', num: 8},{name: '江津区', num: 8},]},{name: '天津', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '广西', value: 0, addList: []},{name: '新疆', value: 30, addList: [{name: '乌鲁木齐', num: 20},{name: '喀什', num: 4},{name: '和田', num: 3},{name: '伊犁哈萨克自治州', num: 2},{name: '克州', num: 1},]},{name: '河南', value: 200, addList: [{name: '郑州', num: 200},]},{name: '辽宁', value: 4, addList: [{name: '沈阳', num: 4},]},{name: '河北', value: 1, addList: [{name: '定州', num: 1},]},{name: '山西', value: 66, addList: [{name: '大同', num: 23},{name: '太原', num: 18},{name: '忻州', num: 11},{name: '吕梁', num: 8},{name: '朔州', num: 3},]},{name: '湖南', value: 6, addList: [{name: '郴州', num: 2},{name: '长沙', num: 2},{name: '娄底', num: 1},{name: '益阳', num: 1},]},{name: '安徽', value: 2, addList: [{name: '淮北', num: 1},{name: '淮南', num: 1},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '甘肃', value: 13, addList: [{name: '兰州', num: 13},]},{name: '贵州', value: 10, addList: [{name: '毕节', num: 5},{name: '遵义', num: 5},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
