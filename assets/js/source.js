    ...
    series: [
      {
        ...
        data: [
          { value: 103, name: '本土新增确诊' },
          { value: 356, name: '本土新增无症状	' },
          { value: 12, name: '新增境外输入' },
          { value: 934, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 1, addList: [{name: '浦东', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 103, addList: [{name: '广州', num: 83},{name: '深圳', num: 10},{name: '汕头', num: 6},{name: '梅州', num: 3},{name: '茂名', num: 1},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 9, addList: [{name: '成都', num: 5},{name: '外省返川人员', num: 2},{name: '绵阳', num: 1},{name: '凉山', num: 1},]},{name: '福建', value: 52, addList: [{name: '福州', num: 52},]},{name: '北京', value: 28, addList: [{name: '朝阳', num: 6},{name: '平谷区', num: 6},{name: '密云', num: 5},{name: '未公布来源', num: 5},{name: '昌平', num: 2},]},{name: '内蒙古', value: 192, addList: [{name: '呼和浩特', num: 188},{name: '鄂尔多斯', num: 3},{name: '巴彦淖尔', num: 1},]},{name: '陕西', value: 17, addList: [{name: '西安', num: 10},{name: '渭南', num: 4},{name: '汉中', num: 2},{name: '安康', num: 1},]},{name: '河南', value: 35, addList: [{name: '郑州', num: 35},]},{name: '浙江', value: 0, addList: []},{name: '黑龙江', value: 6, addList: [{name: '哈尔滨', num: 5},{name: '黑河', num: 1},]},{name: '山东', value: 6, addList: [{name: '青岛', num: 4},{name: '枣庄', num: 2},]},{name: '江苏', value: 4, addList: [{name: '南京', num: 2},{name: '淮安', num: 1},{name: '盐城', num: 1},]},{name: '云南', value: 4, addList: [{name: '德宏州', num: 2},{name: '昭通市', num: 2},]},{name: '天津', value: 1, addList: [{name: '宝坻区', num: 1},]},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 0, addList: []},{name: '河北', value: 0, addList: []},{name: '新疆', value: 25, addList: [{name: '乌鲁木齐', num: 21},{name: '未公布来源', num: 4},]},{name: '湖南', value: 5, addList: [{name: '邵阳', num: 2},{name: '株洲', num: 2},{name: '怀化', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '重庆', value: 10, addList: [{name: '永川区', num: 3},{name: '沙坪坝区', num: 2},{name: '江北区', num: 2},{name: '大足区', num: 1},{name: '渝北区', num: 1},]},{name: '山西', value: 28, addList: [{name: '大同', num: 10},{name: '吕梁', num: 7},{name: '忻州', num: 6},{name: '阳泉', num: 4},{name: '晋城', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '宁夏', value: 2, addList: [{name: '中卫', num: 2},]},{name: '南海诸岛', value: 0, addList: []}];
