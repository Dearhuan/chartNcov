    ...
    series: [
      {
        ...
        data: [
          { value: 592, name: '本土新增确诊' },
          { value: 2611, name: '本土新增无症状	' },
          { value: 16, name: '新增境外输入' },
          { value: 1904, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 2, addList: [{name: '武汉', num: 2},]},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 592, addList: [{name: '广州', num: 478},{name: '汕头', num: 44},{name: '茂名', num: 39},{name: '清远', num: 20},{name: '湛江', num: 3},]},{name: '海南', value: 2, addList: [{name: '三亚', num: 1},{name: '海口', num: 1},]},{name: '四川', value: 40, addList: [{name: '外省返川人员', num: 16},{name: '巴中', num: 12},{name: '成都', num: 7},{name: '乐山', num: 2},{name: '自贡', num: 2},]},{name: '内蒙古', value: 135, addList: [{name: '呼和浩特', num: 129},{name: '赤峰', num: 4},{name: '鄂尔多斯', num: 2},]},{name: '福建', value: 3, addList: [{name: '福州', num: 2},{name: '泉州', num: 1},]},{name: '北京', value: 32, addList: [{name: '朝阳', num: 19},{name: '昌平', num: 5},{name: '未公布来源', num: 2},{name: '通州', num: 2},{name: '大兴', num: 2},]},{name: '陕西', value: 13, addList: [{name: '安康', num: 10},{name: '西安', num: 2},{name: '榆林', num: 1},]},{name: '河南', value: 159, addList: [{name: '郑州', num: 159},]},{name: '浙江', value: 5, addList: [{name: '杭州', num: 2},{name: '温州', num: 1},]},{name: '黑龙江', value: 3, addList: [{name: '哈尔滨', num: 2},{name: '绥化', num: 1},]},{name: '山东', value: 6, addList: [{name: '青岛', num: 5},{name: '枣庄', num: 1},]},{name: '江苏', value: 2, addList: [{name: '南京', num: 1},{name: '盐城', num: 1},]},{name: '云南', value: 13, addList: [{name: '昭通市', num: 7},{name: '昆明', num: 3},{name: '德宏州', num: 3},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 0, addList: []},{name: '河北', value: 1, addList: [{name: '沧州', num: 1},]},{name: '新疆', value: 34, addList: [{name: '乌鲁木齐', num: 32},{name: '伊犁哈萨克自治州', num: 2},]},{name: '湖南', value: 8, addList: [{name: '株洲', num: 4},{name: '怀化', num: 2},{name: '永州', num: 1},{name: '长沙', num: 1},]},{name: '重庆', value: 157, addList: [{name: '大足区', num: 46},{name: '沙坪坝区', num: 42},{name: '九龙坡区', num: 7},{name: '北碚区', num: 7},{name: '南岸区', num: 7},]},{name: '山西', value: 69, addList: [{name: '大同', num: 62},{name: '晋中', num: 4},{name: '吕梁', num: 1},{name: '忻州', num: 1},{name: '阳泉', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 1, addList: [{name: '萍乡', num: 1},]},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '甘肃', value: 10, addList: [{name: '兰州', num: 10},]},{name: '贵州', value: 1, addList: [{name: '贵阳', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 4, addList: [{name: '玉树州', num: 4},{name: '西宁', num: 2},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
