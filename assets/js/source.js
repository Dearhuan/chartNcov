    ...
    series: [
      {
        ...
        data: [
          { value: 27, name: '本土新增确诊' },
          { value: 88, name: '本土新增无症状	' },
          { value: 11, name: '新增境外输入' },
          { value: 194, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 27, addList: [{name: '广州', num: 19},{name: '佛山', num: 3},{name: '深圳', num: 2},{name: '江门', num: 1},{name: '阳江', num: 1},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 15, addList: [{name: '绵阳', num: 7},{name: '外省返川人员', num: 5},{name: '成都', num: 1},{name: '宜宾', num: 1},{name: '眉山', num: 1},]},{name: '福建', value: 13, addList: [{name: '南平', num: 10},{name: '莆田', num: 1},{name: '泉州', num: 1},{name: '厦门', num: 1},]},{name: '北京', value: 6, addList: [{name: '未公布来源', num: 3},{name: '朝阳', num: 2},{name: '丰台', num: 1},]},{name: '内蒙古', value: 37, addList: [{name: '鄂尔多斯', num: 20},{name: '呼和浩特', num: 8},{name: '包头', num: 4},{name: '赤峰', num: 3},{name: '锡林郭勒', num: 2},]},{name: '陕西', value: 13, addList: [{name: '西安', num: 9},{name: '汉中', num: 3},{name: '渭南', num: 1},]},{name: '浙江', value: 1, addList: [{name: '台州', num: 1},]},{name: '河南', value: 4, addList: [{name: '郑州', num: 4},]},{name: '黑龙江', value: 5, addList: [{name: '绥化', num: 4},{name: '哈尔滨', num: 1},]},{name: '山东', value: 2, addList: [{name: '枣庄', num: 2},]},{name: '云南', value: 2, addList: [{name: '德宏州', num: 1},{name: '昆明', num: 1},]},{name: '江苏', value: 10, addList: [{name: '南京', num: 10},]},{name: '天津', value: 1, addList: [{name: '西青区', num: 1},]},{name: '广西', value: 0, addList: []},{name: '河北', value: 1, addList: [{name: '秦皇岛', num: 1},]},{name: '辽宁', value: 0, addList: []},{name: '新疆', value: 12, addList: [{name: '乌鲁木齐', num: 7},]},{name: '湖南', value: 24, addList: [{name: '邵阳', num: 19},{name: '怀化', num: 4},{name: '长沙', num: 1},]},{name: '安徽', value: 2, addList: [{name: '合肥', num: 2},]},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '拉萨', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '重庆', value: 6, addList: [{name: '永川区', num: 6},]},{name: '山西', value: 26, addList: [{name: '大同', num: 21},{name: '朔州', num: 3},{name: '运城', num: 1},{name: '吕梁', num: 1},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 6, addList: [{name: '未公布来源', num: 6},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
