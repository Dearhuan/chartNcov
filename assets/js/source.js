    ...
    series: [
      {
        ...
        data: [
          { value: 1437, name: '本土新增确诊' },
          { value: 2713, name: '本土新增无症状	' },
          { value: 14, name: '新增境外输入' },
          { value: 12278, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 12, addList: [{name: '武汉', num: 12},]},{name: '上海', value: 39, addList: [{name: '浦东', num: 9},{name: '松江', num: 3},{name: '闵行', num: 3},{name: '静安', num: 2},{name: '嘉定', num: 1},]},{name: '广东', value: 1437, addList: [{name: '广州', num: 1042},{name: '江门', num: 57},{name: '深圳', num: 49},{name: '中山', num: 47},{name: '茂名', num: 37},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 1168, addList: [{name: '朝阳', num: 307},{name: '石景山', num: 124},{name: '通州', num: 116},{name: '海淀', num: 96},{name: '丰台', num: 87},]},{name: '四川', value: 139, addList: [{name: '成都', num: 112},{name: '外省返川人员', num: 13},{name: '眉山', num: 4},{name: '泸州', num: 3},{name: '乐山', num: 3},]},{name: '海南', value: 89, addList: []},{name: '河南', value: 161, addList: [{name: '郑州', num: 161},]},{name: '内蒙古', value: 51, addList: [{name: '呼和浩特', num: 41},{name: '鄂尔多斯', num: 6},{name: '赤峰', num: 4},]},{name: '重庆', value: 155, addList: [{name: '九龙坡区', num: 32},{name: '綦江区', num: 12},{name: '万盛经开区', num: 12},{name: '渝北区', num: 11},{name: '奉节县', num: 8},]},{name: '福建', value: 126, addList: [{name: '泉州', num: 38},{name: '厦门', num: 29},{name: '漳州', num: 23},{name: '三明', num: 21},{name: '福州', num: 9},]},{name: '陕西', value: 27, addList: [{name: '汉中', num: 12},{name: '榆林', num: 5},{name: '安康', num: 5},{name: '渭南', num: 2},{name: '延安', num: 2},]},{name: '黑龙江', value: 94, addList: [{name: '哈尔滨', num: 40},{name: '齐齐哈尔', num: 32},{name: '牡丹江', num: 7},{name: '大兴安岭', num: 6},{name: '佳木斯', num: 5},]},{name: '浙江', value: 89, addList: [{name: '杭州', num: 21},{name: '衢州', num: 18},{name: '绍兴', num: 14},{name: '宁波', num: 10},{name: '丽水', num: 9},]},{name: '山西', value: 18, addList: []},{name: '云南', value: 56, addList: []},{name: '山东', value: 50, addList: [{name: '济南', num: 34},{name: '威海', num: 10},{name: '淄博', num: 3},{name: '青岛', num: 1},{name: '聊城', num: 1},]},{name: '江苏', value: 41, addList: [{name: '南京', num: 13},{name: '宿迁', num: 12},{name: '苏州', num: 6},{name: '南通', num: 3},{name: '盐城', num: 2},]},{name: '辽宁', value: 34, addList: [{name: '沈阳', num: 30},{name: '大连', num: 2},{name: '盘锦', num: 1},{name: '阜新', num: 1},]},{name: '河北', value: 0, addList: []},{name: '新疆', value: 4, addList: [{name: '喀什', num: 2},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 0, addList: []},{name: '湖南', value: 7, addList: [{name: '长沙', num: 3},{name: '岳阳', num: 2},]},{name: '贵州', value: 212, addList: []},{name: '安徽', value: 8, addList: []},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 1, addList: [{name: '九江', num: 1},]},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 10, addList: []},{name: '宁夏', value: 2, addList: [{name: '银川', num: 2},]},{name: '南海诸岛', value: 0, addList: []}];
