    ...
    series: [
      {
        ...
        data: [
          { value: 224, name: '本土新增确诊' },
          { value: 1882, name: '本土新增无症状	' },
          { value: 10, name: '新增境外输入' },
          { value: 1360, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 1, addList: [{name: '武汉', num: 1},]},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 224, addList: [{name: '广州', num: 158},{name: '汕头', num: 28},{name: '茂名', num: 25},{name: '清远', num: 5},{name: '深圳', num: 3},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 19, addList: [{name: '乐山', num: 9},{name: '外省返川人员', num: 5},{name: '巴中', num: 2},{name: '自贡', num: 1},]},{name: '福建', value: 5, addList: [{name: '福州', num: 3},{name: '南平', num: 2},]},{name: '内蒙古', value: 57, addList: [{name: '呼和浩特', num: 55},{name: '鄂尔多斯', num: 1},{name: '阿拉善盟', num: 1},]},{name: '北京', value: 41, addList: [{name: '朝阳', num: 20},{name: '密云', num: 6},{name: '未公布来源', num: 4},{name: '通州', num: 3},{name: '东城', num: 3},]},{name: '陕西', value: 7, addList: [{name: '西安', num: 4},{name: '汉中', num: 2},{name: '安康', num: 1},]},{name: '河南', value: 42, addList: [{name: '郑州', num: 41},{name: '濮阳', num: 1},]},{name: '浙江', value: 0, addList: []},{name: '黑龙江', value: 9, addList: [{name: '哈尔滨', num: 7},{name: '绥化', num: 2},]},{name: '山东', value: 5, addList: [{name: '青岛', num: 4},{name: '枣庄', num: 1},]},{name: '江苏', value: 1, addList: [{name: '南京', num: 1},]},{name: '云南', value: 10, addList: [{name: '昆明', num: 6},{name: '德宏州', num: 4},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 0, addList: []},{name: '河北', value: 1, addList: [{name: '石家庄', num: 1},]},{name: '新疆', value: 30, addList: [{name: '乌鲁木齐', num: 28},{name: '伊犁哈萨克自治州', num: 2},]},{name: '湖南', value: 10, addList: [{name: '邵阳', num: 9},{name: '株洲', num: 1},]},{name: '重庆', value: 42, addList: [{name: '沙坪坝区', num: 17},{name: '大足区', num: 5},{name: '九龙坡区', num: 5},{name: '渝北区', num: 4},{name: '合川区', num: 2},]},{name: '安徽', value: 0, addList: []},{name: '山西', value: 22, addList: [{name: '大同', num: 20},{name: '忻州', num: 2},]},{name: '江西', value: 1, addList: [{name: '南昌', num: 1},]},{name: '西藏', value: 0, addList: []},{name: '甘肃', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 3, addList: [{name: '西宁', num: 3},]},{name: '宁夏', value: 2, addList: [{name: '中卫', num: 2},]},{name: '南海诸岛', value: 0, addList: []}];
