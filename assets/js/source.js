    ...
    series: [
      {
        ...
        data: [
          { value: 857, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 17, name: '新增境外输入' },
          { value: 6796, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 22, addList: [{name: '未公布来源', num: 22},]},{name: '广东', value: 857, addList: [{name: '未公布来源', num: 786},{name: '深圳', num: 71},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 494, addList: [{name: '未公布来源', num: 494},]},{name: '四川', value: 67, addList: [{name: '未公布来源', num: 67},]},{name: '海南', value: 23, addList: [{name: '海口', num: 19},{name: '儋州', num: 2},{name: '陵水县', num: 1},{name: '临高县', num: 1},]},{name: '重庆', value: 143, addList: [{name: '未公布来源', num: 143},]},{name: '河南', value: 67, addList: [{name: '郑州', num: 67},]},{name: '内蒙古', value: 21, addList: [{name: '未公布来源', num: 21},]},{name: '福建', value: 61, addList: [{name: '福州', num: 16},{name: '泉州', num: 10},{name: '三明', num: 9},{name: '宁德', num: 9},{name: '漳州', num: 8},]},{name: '浙江', value: 61, addList: [{name: '杭州', num: 45},{name: '宁波', num: 7},{name: '嘉兴', num: 4},{name: '温州', num: 3},{name: '湖州', num: 2},]},{name: '陕西', value: 8, addList: [{name: '未公布来源', num: 8},]},{name: '黑龙江', value: 15, addList: [{name: '未公布来源', num: 15},]},{name: '山西', value: 3, addList: [{name: '临汾', num: 2},{name: '运城', num: 1},]},{name: '山东', value: 17, addList: [{name: '济南', num: 15},{name: '滨州', num: 1},{name: '烟台', num: 1},]},{name: '云南', value: 20, addList: [{name: '未公布来源', num: 20},]},{name: '江苏', value: 10, addList: [{name: '未公布来源', num: 10},]},{name: '辽宁', value: 20, addList: [{name: '沈阳', num: 20},]},{name: '河北', value: 12, addList: [{name: '未公布来源', num: 12},]},{name: '天津', value: 16, addList: [{name: '未公布来源', num: 16},]},{name: '新疆', value: 0, addList: []},{name: '湖南', value: 0, addList: []},{name: '广西', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '贵州', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '安徽', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 0, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
