  ...
  var option_ch_now = {
    ...
    xAxis: {
      type: 'category',
      boundaryGap: false,
      data: ["07.12","07.13","07.14","07.15","07.16","07.17",]
    },
    yAxis: {
      type: 'value'
    },
    series: [
      {
        ...
        data: [77937,77937,77937,77937,77937,77937,]
      },
      {
        name: '无症状感染',
        type: 'line',
      ...
      },
      {
        ...
        data: [228687,228687,228687,228687,228687,228687,]
      }
    ]
  }
