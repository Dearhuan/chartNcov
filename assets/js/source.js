    ...
    series: [
      {
        ...
        data: [
          { value: 500, name: '本土新增确诊' },
          { value: 2507, name: '本土新增无症状	' },
          { value: 14, name: '新增境外输入' },
          { value: 2301, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 0, addList: []},{name: '吉林', value: 0, addList: []},{name: '广东', value: 500, addList: [{name: '广州', num: 423},{name: '茂名', num: 32},{name: '汕头', num: 27},{name: '清远', num: 13},{name: '潮州', num: 2},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 48, addList: [{name: '外省返川人员', num: 13},{name: '成都', num: 11},{name: '巴中', num: 11},{name: '乐山', num: 7},{name: '眉山', num: 4},]},{name: '内蒙古', value: 107, addList: [{name: '呼和浩特', num: 101},{name: '鄂尔多斯', num: 3},{name: '赤峰', num: 3},]},{name: '福建', value: 2, addList: [{name: '泉州', num: 2},]},{name: '北京', value: 34, addList: [{name: '朝阳', num: 19},{name: '昌平', num: 3},{name: '丰台', num: 3},{name: '通州', num: 2},{name: '海淀', num: 2},]},{name: '陕西', value: 12, addList: [{name: '西安', num: 6},{name: '安康', num: 5},{name: '汉中', num: 1},]},{name: '浙江', value: 3, addList: [{name: '温州', num: 2},{name: '湖州', num: 1},]},{name: '黑龙江', value: 9, addList: [{name: '哈尔滨', num: 7},{name: '黑河', num: 2},]},{name: '山东', value: 6, addList: [{name: '青岛', num: 3},{name: '枣庄', num: 2},{name: '济宁', num: 1},]},{name: '江苏', value: 1, addList: [{name: '南京', num: 1},]},{name: '云南', value: 14, addList: [{name: '红河', num: 8},{name: '昆明', num: 3},{name: '德宏州', num: 2},{name: '昭通市', num: 1},]},{name: '天津', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '广西', value: 0, addList: []},{name: '新疆', value: 32, addList: [{name: '乌鲁木齐', num: 31},{name: '伊犁哈萨克自治州', num: 1},]},{name: '辽宁', value: 4, addList: [{name: '沈阳', num: 2},{name: '盘锦', num: 2},]},{name: '河北', value: 0, addList: []},{name: '重庆', value: 123, addList: [{name: '大足区', num: 33},{name: '渝北区', num: 25},{name: '沙坪坝区', num: 20},{name: '垫江县', num: 8},{name: '北碚区', num: 6},]},{name: '湖南', value: 13, addList: [{name: '株洲', num: 8},{name: '邵阳', num: 3},{name: '永州', num: 1},{name: '衡阳', num: 1},]},{name: '山西', value: 35, addList: [{name: '大同', num: 31},{name: '晋中', num: 2},{name: '太原', num: 1},{name: '临汾', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '昌都', num: 1},]},{name: '甘肃', value: 7, addList: [{name: '兰州', num: 5},{name: '陇南', num: 2},]},{name: '河南', value: 178, addList: [{name: '郑州', num: 177},{name: '信阳', num: 1},]},{name: '贵州', value: 1, addList: [{name: '黔西南州', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 1, addList: [{name: '西宁', num: 1},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
