    ...
    series: [
      {
        ...
        data: [
          { value: 1791, name: '本土新增确诊' },
          { value: 7505, name: '本土新增无症状	' },
          { value: 19, name: '新增境外输入' },
          { value: 8013, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 9, addList: [{name: '武汉', num: 9},]},{name: '上海', value: 9, addList: [{name: '青浦', num: 3},{name: '嘉定', num: 2},{name: '宝山', num: 2},{name: '松江', num: 1},{name: '闵行', num: 1},]},{name: '吉林', value: 7, addList: [{name: '松原', num: 5},{name: '延边', num: 2},]},{name: '广东', value: 1791, addList: [{name: '广州', num: 1645},{name: '湛江', num: 34},{name: '深圳', num: 33},{name: '佛山', num: 16},{name: '东莞', num: 15},]},{name: '海南', value: 5, addList: [{name: '三亚', num: 4},{name: '陵水县', num: 1},]},{name: '四川', value: 194, addList: [{name: '成都', num: 144},{name: '外省返川人员', num: 20},{name: '德阳', num: 10},{name: '阿坝', num: 7},{name: '内江', num: 4},]},{name: '北京', value: 509, addList: [{name: '朝阳', num: 175},{name: '海淀', num: 62},{name: '通州', num: 48},{name: '东城', num: 41},{name: '大兴', num: 39},]},{name: '内蒙古', value: 87, addList: [{name: '呼和浩特', num: 55},{name: '鄂尔多斯', num: 14},{name: '赤峰', num: 9},{name: '兴安盟', num: 7},{name: '呼伦贝尔', num: 1},]},{name: '福建', value: 28, addList: [{name: '厦门', num: 11},{name: '三明', num: 5},{name: '龙岩', num: 4},{name: '漳州', num: 4},{name: '福州', num: 3},]},{name: '陕西', value: 37, addList: [{name: '渭南', num: 11},{name: '汉中', num: 8},{name: '安康', num: 7},{name: '西安', num: 5},{name: '铜川', num: 4},]},{name: '重庆', value: 409, addList: [{name: '渝北区', num: 201},{name: '江北区', num: 40},{name: '九龙坡区', num: 23},{name: '沙坪坝区', num: 21},{name: '云阳县', num: 20},]},{name: '黑龙江', value: 98, addList: [{name: '哈尔滨', num: 89},{name: '齐齐哈尔', num: 7},{name: '绥化', num: 1},{name: '双鸭山', num: 1},]},{name: '浙江', value: 35, addList: [{name: '杭州', num: 10},{name: '绍兴', num: 7},{name: '温州', num: 5},{name: '衢州', num: 4},{name: '丽水', num: 4},]},{name: '山东', value: 52, addList: [{name: '济南', num: 40},{name: '青岛', num: 8},{name: '泰安', num: 3},{name: '烟台', num: 1},]},{name: '云南', value: 23, addList: [{name: '昆明', num: 4},{name: '昭通市', num: 4},{name: '德宏州', num: 3},{name: '丽江市', num: 2},{name: '曲靖', num: 2},]},{name: '河南', value: 159, addList: [{name: '郑州', num: 153},{name: '济源示范区', num: 4},{name: '漯河', num: 1},{name: '信阳', num: 1},]},{name: '江苏', value: 28, addList: [{name: '南京', num: 12},{name: '连云港', num: 10},{name: '盐城', num: 2},{name: '无锡', num: 2},{name: '镇江', num: 1},]},{name: '山西', value: 247, addList: [{name: '朔州', num: 66},{name: '太原', num: 57},{name: '吕梁', num: 56},{name: '阳泉', num: 30},{name: '大同', num: 19},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '新疆', value: 18, addList: [{name: '喀什', num: 8},{name: '和田', num: 7},{name: '乌鲁木齐', num: 3},]},{name: '广西', value: 3, addList: [{name: '桂林', num: 3},]},{name: '辽宁', value: 39, addList: [{name: '沈阳', num: 28},{name: '铁岭', num: 9},{name: '抚顺', num: 1},{name: '辽阳', num: 1},]},{name: '河北', value: 64, addList: [{name: '石家庄', num: 55},{name: '衡水', num: 6},{name: '廊坊', num: 2},{name: '邯郸', num: 1},]},{name: '湖南', value: 23, addList: [{name: '长沙', num: 8},{name: '株洲', num: 6},{name: '郴州', num: 4},{name: '常德', num: 2},{name: '张家界', num: 2},]},{name: '安徽', value: 2, addList: [{name: '蚌埠', num: 1},{name: '铜陵', num: 1},]},{name: '甘肃', value: 7, addList: [{name: '兰州', num: 7},]},{name: '江西', value: 1, addList: [{name: '九江', num: 1},]},{name: '西藏', value: 0, addList: []},{name: '贵州', value: 34, addList: [{name: '遵义', num: 21},{name: '毕节', num: 6},{name: '铜仁', num: 2},{name: '六盘水', num: 2},{name: '贵阳', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 8, addList: []},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
