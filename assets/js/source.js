    ...
    series: [
      {
        ...
        data: [
          { value: 1325, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 47, name: '新增境外输入' },
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 47, addList: [{name: '未公布来源', num: 47},]},{name: '广东', value: 1325, addList: [{name: '广州', num: 546},{name: '汕头', num: 93},{name: '珠海', num: 93},{name: '深圳', num: 90},{name: '茂名', num: 86},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 471, addList: [{name: '未公布来源', num: 471},]},{name: '四川', value: 97, addList: [{name: '未公布来源', num: 97},]},{name: '海南', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '重庆', value: 209, addList: [{name: '未公布来源', num: 209},]},{name: '河南', value: 42, addList: [{name: '未公布来源', num: 42},]},{name: '内蒙古', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '福建', value: 187, addList: []},{name: '浙江', value: 37, addList: [{name: '未公布来源', num: 37},]},{name: '陕西', value: 31, addList: [{name: '未公布来源', num: 31},]},{name: '云南', value: 157, addList: [{name: '未公布来源', num: 157},]},{name: '黑龙江', value: 15, addList: []},{name: '山西', value: 46, addList: [{name: '运城', num: 22},{name: '临汾', num: 16},{name: '太原', num: 5},{name: '晋城', num: 3},]},{name: '山东', value: 20, addList: [{name: '未公布来源', num: 20},]},{name: '江苏', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '辽宁', value: 0, addList: []},{name: '湖南', value: 115, addList: [{name: '未公布来源', num: 115},]},{name: '河北', value: 14, addList: [{name: '未公布来源', num: 14},]},{name: '天津', value: 77, addList: [{name: '未公布来源', num: 77},]},{name: '新疆', value: 0, addList: []},{name: '广西', value: 10, addList: [{name: '未公布来源', num: 10},]},{name: '江西', value: 40, addList: [{name: '未公布来源', num: 40},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '安徽', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '青海', value: 6, addList: [{name: '未公布来源', num: 6},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
