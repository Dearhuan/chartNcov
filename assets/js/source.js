    ...
    series: [
      {
        ...
        data: [
          { value: 125, name: '本土新增确诊' },
          { value: 298, name: '本土新增无症状	' },
          { value: 10, name: '新增境外输入' },
          { value: 846, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 1, addList: [{name: '武汉', num: 1},]},{name: '上海', value: 1, addList: [{name: '浦东', num: 1},]},{name: '吉林', value: 0, addList: []},{name: '广东', value: 125, addList: [{name: '广州', num: 85},{name: '深圳', num: 18},{name: '梅州', num: 9},{name: '江门', num: 5},{name: '汕头', num: 5},]},{name: '海南', value: 0, addList: []},{name: '四川', value: 4, addList: [{name: '外省返川人员', num: 2},{name: '绵阳', num: 1},{name: '阿坝', num: 1},]},{name: '福建', value: 39, addList: [{name: '福州', num: 37},{name: '南平', num: 2},]},{name: '北京', value: 28, addList: [{name: '密云', num: 8},{name: '昌平', num: 7},{name: '朝阳', num: 4},{name: '未公布来源', num: 1},{name: '平谷区', num: 1},]},{name: '内蒙古', value: 24, addList: [{name: '呼和浩特', num: 20},{name: '鄂尔多斯', num: 4},]},{name: '陕西', value: 8, addList: [{name: '西安', num: 4},{name: '汉中', num: 2},{name: '渭南', num: 1},{name: '咸阳', num: 1},]},{name: '河南', value: 64, addList: [{name: '郑州', num: 64},]},{name: '浙江', value: 0, addList: []},{name: '黑龙江', value: 12, addList: [{name: '绥化', num: 5},{name: '哈尔滨', num: 3},{name: '黑河', num: 3},{name: '牡丹江', num: 1},]},{name: '山东', value: 4, addList: [{name: '枣庄', num: 2},{name: '青岛', num: 2},]},{name: '江苏', value: 8, addList: [{name: '南京', num: 8},]},{name: '云南', value: 3, addList: [{name: '德宏州', num: 3},]},{name: '天津', value: 0, addList: []},{name: '广西', value: 0, addList: []},{name: '辽宁', value: 2, addList: [{name: '朝阳市', num: 1},{name: '沈阳', num: 1},]},{name: '河北', value: 0, addList: []},{name: '新疆', value: 30, addList: [{name: '乌鲁木齐', num: 25},{name: '未公布来源', num: 5},]},{name: '湖南', value: 10, addList: [{name: '怀化', num: 5},{name: '邵阳', num: 4},{name: '株洲', num: 1},]},{name: '安徽', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '重庆', value: 13, addList: [{name: '永川区', num: 8},{name: '沙坪坝区', num: 4},{name: '大足区', num: 1},]},{name: '甘肃', value: 0, addList: []},{name: '山西', value: 24, addList: [{name: '大同', num: 22},{name: '吕梁', num: 1},{name: '晋城', num: 1},]},{name: '贵州', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 8, addList: [{name: '未公布来源', num: 8},]},{name: '宁夏', value: 1, addList: [{name: '中卫', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
