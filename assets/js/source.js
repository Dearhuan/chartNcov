    ...
    series: [
      {
        ...
        data: [
          { value: 892, name: '本土新增确诊' },
          { value: 7584, name: '本土新增无症状	' },
          { value: 23, name: '新增境外输入' },
          { value: 7567, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 12, addList: [{name: '武汉', num: 12},]},{name: '上海', value: 9, addList: [{name: '浦东', num: 2},{name: '嘉定', num: 2},{name: '松江', num: 2},{name: '青浦', num: 1},{name: '闵行', num: 1},]},{name: '吉林', value: 8, addList: [{name: '延边', num: 6},{name: '松原', num: 2},]},{name: '广东', value: 892, addList: [{name: '广州', num: 734},{name: '深圳', num: 28},{name: '佛山', num: 26},{name: '湛江', num: 19},{name: '珠海', num: 18},]},{name: '海南', value: 5, addList: [{name: '海口', num: 3},{name: '三亚', num: 1},{name: '乐东', num: 1},]},{name: '四川', value: 123, addList: [{name: '成都', num: 77},{name: '外省返川人员', num: 21},{name: '阿坝', num: 11},{name: '凉山', num: 5},{name: '内江', num: 3},]},{name: '北京', value: 424, addList: [{name: '朝阳', num: 83},{name: '东城', num: 53},{name: '顺义', num: 45},{name: '通州', num: 43},{name: '海淀', num: 38},]},{name: '内蒙古', value: 85, addList: [{name: '呼和浩特', num: 71},{name: '赤峰', num: 7},{name: '鄂尔多斯', num: 4},{name: '呼伦贝尔', num: 3},]},{name: '福建', value: 41, addList: [{name: '厦门', num: 16},{name: '龙岩', num: 7},{name: '漳州', num: 7},{name: '泉州', num: 6},{name: '三明', num: 2},]},{name: '重庆', value: 258, addList: [{name: '渝北区', num: 106},{name: '九龙坡区', num: 33},{name: '云阳县', num: 16},{name: '江北区', num: 11},{name: '渝中区', num: 11},]},{name: '陕西', value: 30, addList: [{name: '渭南', num: 16},{name: '安康', num: 11},{name: '汉中', num: 2},{name: '延安', num: 1},]},{name: '黑龙江', value: 108, addList: [{name: '哈尔滨', num: 101},{name: '绥化', num: 5},{name: '黑河', num: 1},{name: '大庆', num: 1},]},{name: '浙江', value: 51, addList: [{name: '湖州', num: 15},{name: '绍兴', num: 9},{name: '温州', num: 7},{name: '金华', num: 7},{name: '衢州', num: 5},]},{name: '山东', value: 88, addList: [{name: '济南', num: 38},{name: '青岛', num: 20},{name: '泰安', num: 12},{name: '聊城', num: 9},{name: '淄博', num: 5},]},{name: '云南', value: 47, addList: [{name: '昭通市', num: 16},{name: '昆明', num: 11},{name: '未公布来源', num: 11},{name: '楚雄州', num: 5},{name: '德宏州', num: 1},]},{name: '河南', value: 140, addList: [{name: '郑州', num: 138},{name: '济源示范区', num: 1},{name: '三门峡', num: 1},]},{name: '江苏', value: 32, addList: [{name: '连云港', num: 10},{name: '无锡', num: 7},{name: '南京', num: 5},{name: '盐城', num: 3},{name: '淮安', num: 2},]},{name: '山西', value: 208, addList: [{name: '太原', num: 67},{name: '阳泉', num: 39},{name: '晋城', num: 34},{name: '大同', num: 28},{name: '吕梁', num: 15},]},{name: '天津', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '河北', value: 329, addList: [{name: '石家庄', num: 321},{name: '邢台', num: 3},{name: '廊坊', num: 2},{name: '沧州', num: 2},{name: '邯郸', num: 1},]},{name: '新疆', value: 20, addList: [{name: '喀什', num: 9},{name: '和田', num: 8},{name: '乌鲁木齐', num: 3},]},{name: '广西', value: 2, addList: [{name: '桂林', num: 1},{name: '贺州', num: 1},]},{name: '辽宁', value: 24, addList: [{name: '沈阳', num: 13},{name: '铁岭', num: 10},{name: '抚顺', num: 1},]},{name: '湖南', value: 29, addList: [{name: '郴州', num: 10},{name: '长沙', num: 8},{name: '常德', num: 2},{name: '湘潭', num: 2},{name: '张家界', num: 2},]},{name: '安徽', value: 5, addList: [{name: '池州', num: 3},{name: '蚌埠', num: 1},{name: '宣城', num: 1},]},{name: '甘肃', value: 6, addList: [{name: '兰州', num: 6},]},{name: '江西', value: 9, addList: [{name: '抚州', num: 5},{name: '九江', num: 4},]},{name: '西藏', value: 2, addList: [{name: '拉萨', num: 1},{name: '未公布来源', num: 1},]},{name: '贵州', value: 42, addList: [{name: '贵阳', num: 24},{name: '遵义', num: 8},{name: '毕节', num: 4},{name: '黔东南州', num: 2},{name: '铜仁', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 9, addList: [{name: '西宁', num: 9},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
