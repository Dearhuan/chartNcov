    ...
    series: [
      {
        ...
        data: [
          { value: 915, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 17, name: '新增境外输入' },
          { value: 6525, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 17, addList: [{name: '未公布来源', num: 17},]},{name: '广东', value: 915, addList: [{name: '广州', num: 403},{name: '汕头', num: 116},{name: '深圳', num: 60},{name: '珠海', num: 51},{name: '佛山', num: 48},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 394, addList: [{name: '未公布来源', num: 394},]},{name: '四川', value: 56, addList: [{name: '未公布来源', num: 56},]},{name: '海南', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '重庆', value: 183, addList: [{name: '未公布来源', num: 183},]},{name: '河南', value: 30, addList: [{name: '郑州', num: 30},]},{name: '内蒙古', value: 17, addList: [{name: '未公布来源', num: 17},]},{name: '福建', value: 99, addList: [{name: '福州', num: 57},{name: '泉州', num: 18},{name: '厦门', num: 15},{name: '三明', num: 3},{name: '漳州', num: 2},]},{name: '浙江', value: 45, addList: [{name: '杭州', num: 34},{name: '宁波', num: 7},{name: '嘉兴', num: 3},{name: '湖州', num: 1},]},{name: '陕西', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '黑龙江', value: 5, addList: [{name: '未公布来源', num: 5},]},{name: '山西', value: 9, addList: [{name: '临汾', num: 4},{name: '运城', num: 2},{name: '晋城', num: 1},{name: '忻州', num: 1},{name: '朔州', num: 1},]},{name: '山东', value: 33, addList: []},{name: '云南', value: 55, addList: [{name: '未公布来源', num: 55},]},{name: '江苏', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '辽宁', value: 0, addList: []},{name: '河北', value: 14, addList: [{name: '未公布来源', num: 14},]},{name: '天津', value: 41, addList: [{name: '未公布来源', num: 41},]},{name: '新疆', value: 0, addList: []},{name: '湖南', value: 79, addList: [{name: '未公布来源', num: 79},]},{name: '广西', value: 2, addList: [{name: '未公布来源', num: 2},]},{name: '贵州', value: 0, addList: []},{name: '安徽', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 0, addList: []},{name: '澳门', value: 0, addList: []},{name: '青海', value: 5, addList: [{name: '西宁', num: 3},{name: '黄南州', num: 1},{name: '果洛州', num: 1},]},{name: '宁夏', value: 0, addList: []},{name: '南海诸岛', value: 0, addList: []}];
