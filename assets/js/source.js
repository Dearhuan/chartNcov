    ...
    series: [
      {
        ...
        data: [
          { value: 1386, name: '本土新增确诊' },
          { value: 7705, name: '本土新增无症状	' },
          { value: 23, name: '新增境外输入' },
          { value: 7685, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 8, addList: [{name: '武汉', num: 8},]},{name: '上海', value: 11, addList: [{name: '浦东', num: 4},{name: '松江', num: 3},{name: '普陀', num: 2},{name: '闵行', num: 1},{name: '宝山', num: 1},]},{name: '吉林', value: 4, addList: [{name: '松原', num: 2},{name: '延边', num: 2},]},{name: '广东', value: 1386, addList: [{name: '广州', num: 1177},{name: '深圳', num: 51},{name: '湛江', num: 37},{name: '佛山', num: 37},{name: '肇庆', num: 23},]},{name: '北京', value: 747, addList: [{name: '东城', num: 148},{name: '朝阳', num: 147},{name: '海淀', num: 78},{name: '通州', num: 74},{name: '未公布来源', num: 62},]},{name: '海南', value: 7, addList: [{name: '三亚', num: 3},{name: '海口', num: 3},{name: '乐东', num: 1},]},{name: '四川', value: 117, addList: [{name: '成都', num: 92},{name: '阿坝', num: 7},{name: '外省返川人员', num: 6},{name: '德阳', num: 5},{name: '广安', num: 2},]},{name: '内蒙古', value: 104, addList: [{name: '呼和浩特', num: 66},{name: '鄂尔多斯', num: 27},{name: '呼伦贝尔', num: 7},{name: '赤峰', num: 3},{name: '乌兰察布', num: 1},]},{name: '福建', value: 36, addList: [{name: '厦门', num: 13},{name: '漳州', num: 7},{name: '泉州', num: 5},{name: '三明', num: 4},{name: '龙岩', num: 4},]},{name: '重庆', value: 194, addList: [{name: '南岸区', num: 28},{name: '渝北区', num: 20},{name: '九龙坡区', num: 20},{name: '巴南区', num: 13},{name: '渝中区', num: 13},]},{name: '陕西', value: 51, addList: [{name: '安康', num: 28},{name: '渭南', num: 7},{name: '西安', num: 5},{name: '汉中', num: 4},{name: '延安', num: 4},]},{name: '黑龙江', value: 132, addList: [{name: '哈尔滨', num: 85},{name: '齐齐哈尔', num: 24},{name: '黑河', num: 10},{name: '佳木斯', num: 8},{name: '牡丹江', num: 2},]},{name: '浙江', value: 64, addList: [{name: '衢州', num: 15},{name: '绍兴', num: 11},{name: '杭州', num: 9},{name: '台州', num: 9},{name: '温州', num: 7},]},{name: '河南', value: 169, addList: [{name: '郑州', num: 164},{name: '济源示范区', num: 5},]},{name: '山东', value: 93, addList: [{name: '济南', num: 41},{name: '泰安', num: 18},{name: '青岛', num: 14},{name: '聊城', num: 7},{name: '滨州', num: 6},]},{name: '云南', value: 83, addList: [{name: '昆明', num: 44},{name: '昭通市', num: 16},{name: '未公布来源', num: 6},{name: '大理', num: 5},{name: '红河', num: 3},]},{name: '山西', value: 189, addList: [{name: '临汾', num: 57},{name: '太原', num: 39},{name: '朔州', num: 28},{name: '大同', num: 28},{name: '阳泉', num: 21},]},{name: '江苏', value: 20, addList: [{name: '盐城', num: 6},{name: '连云港', num: 5},{name: '无锡', num: 4},{name: '泰州', num: 2},{name: '南京', num: 1},]},{name: '河北', value: 79, addList: [{name: '石家庄', num: 69},{name: '廊坊', num: 4},{name: '保定', num: 3},{name: '邯郸', num: 1},{name: '沧州', num: 1},]},{name: '天津', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '新疆', value: 20, addList: [{name: '喀什', num: 9},{name: '和田', num: 9},{name: '乌鲁木齐', num: 2},]},{name: '广西', value: 5, addList: [{name: '桂林', num: 4},{name: '来宾', num: 1},]},{name: '辽宁', value: 46, addList: [{name: '沈阳', num: 20},{name: '铁岭', num: 15},{name: '阜新', num: 5},{name: '抚顺', num: 1},{name: '盘锦', num: 1},]},{name: '湖南', value: 26, addList: [{name: '长沙', num: 8},{name: '张家界', num: 5},{name: '岳阳', num: 4},{name: '郴州', num: 2},{name: '株洲', num: 2},]},{name: '安徽', value: 10, addList: [{name: '宣城', num: 5},{name: '合肥', num: 3},{name: '铜陵', num: 1},{name: '芜湖', num: 1},]},{name: '甘肃', value: 5, addList: [{name: '兰州', num: 5},]},{name: '江西', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '西藏', value: 2, addList: [{name: '拉萨', num: 1},{name: '未公布来源', num: 1},]},{name: '贵州', value: 28, addList: [{name: '遵义', num: 16},{name: '贵阳', num: 5},{name: '毕节', num: 4},{name: '黔南州', num: 3},{name: '六盘水', num: 2},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 7, addList: [{name: '西宁', num: 7},]},{name: '宁夏', value: 3, addList: [{name: '固原', num: 2},{name: '中卫', num: 1},]},{name: '南海诸岛', value: 0, addList: []}];
