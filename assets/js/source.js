    ...
    series: [
      {
        ...
        data: [
          { value: 1065, name: '本土新增确诊' },
          { value: 0, name: '本土新增无症状	' },
          { value: 17, name: '新增境外输入' },
          { value: 6470, name: '本土近7日确诊' },
        ]
      }
    ]
  }
  ...
  var mapDatas = [{name: '台湾', value: 0, addList: []},{name: '香港', value: 0, addList: []},{name: '湖北', value: 0, addList: []},{name: '上海', value: 36, addList: [{name: '未公布来源', num: 36},]},{name: '广东', value: 1065, addList: [{name: '广州', num: 505},{name: '云浮', num: 97},{name: '汕头', num: 62},{name: '惠州', num: 61},{name: '深圳', num: 57},]},{name: '吉林', value: 0, addList: []},{name: '北京', value: 428, addList: [{name: '未公布来源', num: 428},]},{name: '四川', value: 61, addList: [{name: '未公布来源', num: 61},]},{name: '海南', value: 2, addList: [{name: '琼中县', num: 1},{name: '保亭', num: 1},]},{name: '重庆', value: 154, addList: [{name: '未公布来源', num: 154},]},{name: '河南', value: 30, addList: [{name: '郑州', num: 30},]},{name: '内蒙古', value: 27, addList: [{name: '未公布来源', num: 27},]},{name: '福建', value: 62, addList: [{name: '福州', num: 18},{name: '漳州', num: 12},{name: '厦门', num: 10},{name: '泉州', num: 10},{name: '龙岩', num: 5},]},{name: '浙江', value: 43, addList: [{name: '杭州', num: 40},{name: '宁波', num: 1},{name: '湖州', num: 1},{name: '温州', num: 1},]},{name: '陕西', value: 3, addList: [{name: '未公布来源', num: 3},]},{name: '黑龙江', value: 7, addList: [{name: '未公布来源', num: 7},]},{name: '山西', value: 16, addList: [{name: '临汾', num: 8},{name: '晋城', num: 4},{name: '运城', num: 3},{name: '忻州', num: 1},]},{name: '山东', value: 39, addList: [{name: '济南', num: 32},{name: '青岛', num: 6},{name: '滨州', num: 1},]},{name: '云南', value: 31, addList: [{name: '未公布来源', num: 31},]},{name: '江苏', value: 10, addList: [{name: '未公布来源', num: 10},]},{name: '辽宁', value: 14, addList: [{name: '大连', num: 9},{name: '沈阳', num: 5},]},{name: '河北', value: 13, addList: [{name: '未公布来源', num: 13},]},{name: '天津', value: 23, addList: [{name: '未公布来源', num: 23},]},{name: '新疆', value: 0, addList: []},{name: '湖南', value: 0, addList: []},{name: '广西', value: 4, addList: [{name: '未公布来源', num: 4},]},{name: '贵州', value: 8, addList: [{name: '未公布来源', num: 8},]},{name: '安徽', value: 0, addList: []},{name: '甘肃', value: 0, addList: []},{name: '江西', value: 0, addList: []},{name: '西藏', value: 1, addList: [{name: '未公布来源', num: 1},]},{name: '澳门', value: 0, addList: []},{name: '青海', value: 11, addList: [{name: '未公布来源', num: 11},]},{name: '宁夏', value: 3, addList: [{name: '银川', num: 3},]},{name: '南海诸岛', value: 0, addList: []}];
